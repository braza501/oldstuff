...
data-atlassian-id="557058:6abab86b-fd61-4467-882d-25c55a8d91e7" />
  ...
  / source  / HW8 / BinarySearchTree.cpp
 &mdash; Bitbucket
</title>
...
<meta name="apitoken" content="{&quot;token&quot;: &quot;3hLKe9DO97ki7kLPFCAflkbnmkXhUip_i6RVI2p-R-Z-PTEeClZbTTr64jAe3pnP3DrYUbWTg647YpLWtijhQOevH7oWew==&quot;, &quot;connectionId&quot;: 619065, &quot;expiration&quot;: 1489896866.188859}">
...
<header id="source-path">
    ...
    <div class="secondary-actions">
      <div class="aui-buttons">
          ...
          <a href="/braza501/c-course-hws/src/286c32a03bb5/HW8/BinarySearchTree.cpp?at=master"
            class="aui-button pjax-trigger" aria-pressed="true">
            Source
          </a>
          <a href="/braza501/c-course-hws/diff/HW8/BinarySearchTree.cpp?diff2=286c32a03bb5&at=master"
            class="aui-button pjax-trigger"
            title="Diff to previous change">
            Diff
          </a>
          <a href="/braza501/c-course-hws/history-node/286c32a03bb5/HW8/BinarySearchTree.cpp?at=master"
            class="aui-button pjax-trigger">
            History
          </a>
  ...
  <div id="editor-container" class="maskable"
       ...
       data-branch="master"
       data-path="HW8/BinarySearchTree.cpp"
       data-source-url="/api/internal/repositories/braza501/c-course-hws/src/286c32a03bb586675f981e6fc28c3f6b037a0d61/HW8/BinarySearchTree.cpp">
  ...
  <span class="aui-icon-dropdown"></span>
          ...
          <a href="/braza501/c-course-hws/full-commit/286c32a03bb5/HW8/BinarySearchTree.cpp" id="full-commit-link"
        ...
        <div class="secondary">
          ...
          <div class="aui-buttons">
              ...
              <a href="/braza501/c-course-hws/annotate/286c32a03bb586675f981e6fc28c3f6b037a0d61/HW8/BinarySearchTree.cpp?at=master"
                 class="aui-button aui-button-light pjax-trigger">Blame</a>
              
            
            <a href="/braza501/c-course-hws/raw/286c32a03bb586675f981e6fc28c3f6b037a0d61/HW8/BinarySearchTree.cpp" class="aui-button aui-button-light">Raw</a>
          </div>
...
<a href="#BinarySearchTree.cpp-41">41</a></pre></div></td><td class="code"><div class="codehilite highlight"><pre><span></span><a name="BinarySearchTree.cpp-1"></a><span class="cp">#include</span> <span class="cpf">&lt;iostream&gt;</span><span class="cp"></span>
<a name="BinarySearchTree.cpp-2"></a><span class="cp">#include</span> <span class="cpf">&lt;algorithm&gt;</span><span class="cp"></span>
<a name="BinarySearchTree.cpp-3"></a><span class="cp">#include</span> <span class="cpf">&quot;CString.h&quot;</span><span class="cp"></span>
...
<a name="BinarySearchTree.cpp-8"></a>
<a name="BinarySearchTree.cpp-9"></a><span class="kt">void</span> <span class="nf">TestBinarySearchTree</span><span class="p">()</span> <span class="p">{</span>
<a name="BinarySearchTree.cpp-10"></a>    <span class="n">CBinarySearchTree</span><span class="o">&lt;</span><span class="kt">int</span><span class="p">,</span> <span class="kt">int</span><span class="o">&gt;</span> <span class="n">tree</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-11"></a>    <span class="n">tree</span><span class="p">.</span><span class="n">Add</span><span class="p">(</span><span class="mi">3</span><span class="p">,</span> <span class="mi">7</span><span class="p">);</span>
<a name="BinarySearchTree.cpp-12"></a>    <span class="n">tree</span><span class="p">.</span><span class="n">Add</span><span class="p">(</span><span class="mi">4</span><span class="p">,</span> <span class="mi">2</span><span class="p">);</span>
<a name="BinarySearchTree.cpp-13"></a>    <span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="n">tree</span><span class="p">.</span><span class="n">Size</span><span class="p">()</span> <span class="o">&lt;&lt;</span> <span class="n">endl</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-14"></a>    <span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="n">tree</span><span class="p">.</span><span class="n">Has</span><span class="p">(</span><span class="mi">5</span><span class="p">)</span> <span class="o">&lt;&lt;</span> <span class="n">endl</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-15"></a>    <span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="n">tree</span><span class="p">[</span><span class="mi">3</span><span class="p">]</span> <span class="o">&lt;&lt;</span> <span class="n">endl</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-16"></a>    <span class="c1">//tree.DeleteAll();</span>
<a name="BinarySearchTree.cpp-17"></a>    <span class="n">tree</span><span class="p">.</span><span class="n">Add</span><span class="p">(</span><span class="mi">5</span><span class="p">,</span> <span class="mi">777</span><span class="p">);</span>
<a name="BinarySearchTree.cpp-18"></a>    <span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="n">tree</span><span class="p">.</span><span class="n">Delete</span><span class="p">(</span><span class="mi">5</span><span class="p">)</span> <span class="o">&lt;&lt;</span> <span class="n">endl</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-19"></a>    <span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="s">&quot;String tree: &quot;</span> <span class="o">&lt;&lt;</span> <span class="n">endl</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-20"></a>    <span class="n">CBinarySearchTree</span><span class="o">&lt;</span><span class="n">CString</span><span class="p">,</span> <span class="kt">int</span><span class="o">&gt;</span> <span class="n">treeB</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-21"></a>    <span class="n">treeB</span><span class="p">.</span><span class="n">Add</span><span class="p">(</span><span class="s">&quot;Alex&quot;</span><span class="p">,</span><span class="mi">776</span><span class="p">);</span>
<a name="BinarySearchTree.cpp-22"></a>    <span class="n">treeB</span><span class="p">.</span><span class="n">Add</span><span class="p">(</span><span class="s">&quot;Sam&quot;</span><span class="p">,</span><span class="mi">22</span><span class="p">);</span>
<a name="BinarySearchTree.cpp-23"></a>    <span class="n">treeB</span><span class="p">.</span><span class="n">Add</span><span class="p">(</span><span class="s">&quot;Jay Z&quot;</span><span class="p">,</span><span class="mi">12</span><span class="p">);</span>
<a name="BinarySearchTree.cpp-24"></a>    <span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="n">treeB</span><span class="p">.</span><span class="n">Size</span><span class="p">()</span> <span class="o">&lt;&lt;</span> <span class="n">endl</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-25"></a>    <span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="n">treeB</span><span class="p">.</span><span class="n">Has</span><span class="p">(</span><span class="s">&quot;Sam&quot;</span><span class="p">)</span> <span class="o">&lt;&lt;</span> <span class="n">endl</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-26"></a>    <span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="n">treeB</span><span class="p">[</span><span class="s">&quot;Alex&quot;</span><span class="p">]</span> <span class="o">&lt;&lt;</span> <span class="n">endl</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-27"></a>    <span class="n">treeB</span><span class="p">[</span><span class="s">&quot;Alex&quot;</span><span class="p">]</span><span class="o">++</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-28"></a>    <span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="n">treeB</span><span class="p">[</span><span class="s">&quot;Alex&quot;</span><span class="p">]</span> <span class="o">&lt;&lt;</span> <span class="n">endl</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-29"></a>    <span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="n">treeB</span><span class="p">.</span><span class="n">MaxDepth</span><span class="p">()</span> <span class="o">&lt;&lt;</span> <span class="n">endl</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-30"></a>    <span class="n">cout</span> <span class="o">&lt;&lt;</span><span class="n">boolalpha</span><span class="o">&lt;&lt;</span><span class="n">treeB</span><span class="p">.</span><span class="n">Has</span><span class="p">(</span><span class="s">&quot;Jay Z&quot;</span><span class="p">)</span> <span class="o">&lt;&lt;</span> <span class="n">endl</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-31"></a>    <span class="n">CBinarySearchTree</span><span class="o">&lt;</span><span class="n">CString</span><span class="p">,</span> <span class="kt">int</span><span class="o">&gt;</span> <span class="n">treeC</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-32"></a>    <span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="n">treeB</span><span class="p">.</span><span class="n">Delete</span><span class="p">(</span><span class="s">&quot;Alex&quot;</span><span class="p">)</span> <span class="o">&lt;&lt;</span> <span class="n">endl</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-33"></a>    <span class="n">treeC</span> <span class="o">=</span> <span class="n">treeB</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-34"></a>    <span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="n">treeC</span><span class="p">.</span><span class="n">Has</span><span class="p">(</span><span class="s">&quot;Alex&quot;</span><span class="p">)</span><span class="o">&lt;&lt;</span> <span class="n">endl</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-35"></a>
<a name="BinarySearchTree.cpp-36"></a><span class="p">}</span>
<a name="BinarySearchTree.cpp-37"></a>
<a name="BinarySearchTree.cpp-38"></a><span class="kt">int</span> <span class="nf">main</span><span class="p">()</span> <span class="p">{</span>
<a name="BinarySearchTree.cpp-39"></a>    <span class="n">TestBinarySearchTree</span><span class="p">();</span>
<a name="BinarySearchTree.cpp-40"></a>    <span class="k">return</span> <span class="mi">0</span><span class="p">;</span>
<a name="BinarySearchTree.cpp-41"></a><span class="p">}</span>
</pre></div>
</td></tr></table>
    </div>
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
            ...
            [[#hasMultipleHeads]]
              [[#heads]]
                <li class="comprev filter-item">
                  <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/HW8/BinarySearchTree.cpp?at=[[safeName]]"
                     title="[[name]]">
                    [[name]] ([[shortChangeset]])
                  </a>
                </li>
            ...
            [[^hasMultipleHeads]]
              <li class="comprev filter-item">
                <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/HW8/BinarySearchTree.cpp?at=[[safeName]]" title="[[name]]">
                  [[name]]
                </a>
              </li>
            [[/hasMultipleHeads]]
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","queueTime":0,"licenseKey":"a2cef8c3d3","agent":"","transactionName":"Z11RZxdWW0cEVkYLDV4XdUYLVEFdClsdAAtEWkZQDlJBGgRFQhFMQl1DXFcZQ10AQkFYBFlUVlEXWEJHAA==","applicationID":"1841284","errorBeacon":"bam.nr-data.net","applicationTime":163}</script>
</body>
</html>