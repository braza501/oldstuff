...
<meta name="apitoken" content="{&quot;token&quot;: &quot;jIYedwnpDwVqZoUtQPT1pVU05DfVszhoEiHNPQcmQpDxsLNkb-o4Hw1iTHpd8iXUj7v9ob25d2d55fj6QKFFx_PCPj-5uw==&quot;, &quot;connectionId&quot;: 619065, &quot;expiration&quot;: 1489896862.374232}">
...
<header id="source-path">
    ...
    <div class="secondary-actions">
      <div class="aui-buttons">
          ...
          <a href="/braza501/c-course-hws/src/286c32a03bb5/HW8/Assert.h?at=master"
            class="aui-button pjax-trigger" aria-pressed="true">
            Source
          </a>
          <a href="/braza501/c-course-hws/diff/HW8/Assert.h?diff2=286c32a03bb5&at=master"
            class="aui-button pjax-trigger"
            title="Diff to previous change">
            Diff
          </a>
          <a href="/braza501/c-course-hws/history-node/286c32a03bb5/HW8/Assert.h?at=master"
            class="aui-button pjax-trigger">
            History
          </a>
  ...
  <h1>
        ...
        <a href="/braza501/c-course-hws/src/286c32a03bb5?at=master"
          class="pjax-trigger root" title="braza501/c-course-hws at 286c32a03bb5">C++ Course HWs</a> /
            ...
            <span class="file-name">Assert.h</span>
  ...
  <div id="editor-container" class="maskable"
       ...
       data-branch="master"
       data-path="HW8/Assert.h"
       data-source-url="/api/internal/repositories/braza501/c-course-hws/src/286c32a03bb586675f981e6fc28c3f6b037a0d61/HW8/Assert.h">
  ...
  <span class="aui-icon-dropdown"></span>
          ...
          <a href="/braza501/c-course-hws/full-commit/286c32a03bb5/HW8/Assert.h" id="full-commit-link"
        ...
        <div class="secondary">
          ...
          <div class="aui-buttons">
              ...
              <a href="/braza501/c-course-hws/annotate/286c32a03bb586675f981e6fc28c3f6b037a0d61/HW8/Assert.h?at=master"
                 class="aui-button aui-button-light pjax-trigger">Blame</a>
              
            
            <a href="/braza501/c-course-hws/raw/286c32a03bb586675f981e6fc28c3f6b037a0d61/HW8/Assert.h" class="aui-button aui-button-light">Raw</a>
          </div>
    ...
    <div class="file-source">
      <table class="codehilite highlighttable"><tr><td class="linenos"><div class="linenodiv"><pre><a href="#Assert.h-1"> 1</a>
<a href="#Assert.h-2"> 2</a>
<a href="#Assert.h-3"> 3</a>
<a href="#Assert.h-4"> 4</a>
<a href="#Assert.h-5"> 5</a>
<a href="#Assert.h-6"> 6</a>
<a href="#Assert.h-7"> 7</a>
<a href="#Assert.h-8"> 8</a>
<a href="#Assert.h-9"> 9</a>
<a href="#Assert.h-10">10</a>
<a href="#Assert.h-11">11</a>
<a href="#Assert.h-12">12</a>
<a href="#Assert.h-13">13</a>
<a href="#Assert.h-14">14</a>
<a href="#Assert.h-15">15</a>
<a href="#Assert.h-16">16</a>
<a href="#Assert.h-17">17</a>
<a href="#Assert.h-18">18</a>
<a href="#Assert.h-19">19</a>
<a href="#Assert.h-20">20</a>
<a href="#Assert.h-21">21</a>
<a href="#Assert.h-22">22</a>
<a href="#Assert.h-23">23</a>
<a href="#Assert.h-24">24</a>
<a href="#Assert.h-25">25</a>
<a href="#Assert.h-26">26</a>
<a href="#Assert.h-27">27</a>
<a href="#Assert.h-28">28</a></pre></div></td><td class="code"><div class="codehilite highlight"><pre><span></span><a name="Assert.h-1"></a>
<a name="Assert.h-2"></a><span class="cp">#pragma once</span>
<a name="Assert.h-3"></a>
<a name="Assert.h-4"></a><span class="cp">#include</span> <span class="cpf">&lt;stdexcept&gt;</span><span class="cp"></span>
<a name="Assert.h-5"></a><span class="cp">#include</span> <span class="cpf">&lt;string&gt;</span><span class="cp"></span>
<a name="Assert.h-6"></a>
<a name="Assert.h-7"></a><span class="n">class</span> <span class="nl">assertion_error</span> <span class="p">:</span> <span class="n">public</span> <span class="n">std</span><span class="o">::</span><span class="n">exception</span> <span class="p">{</span>
<a name="Assert.h-8"></a><span class="nl">public</span><span class="p">:</span>
<a name="Assert.h-9"></a>    <span class="n">assertion_error</span><span class="p">(</span> <span class="k">const</span> <span class="kt">char</span><span class="o">*</span> <span class="n">statement</span><span class="p">,</span> <span class="k">const</span> <span class="kt">char</span><span class="o">*</span> <span class="n">functionName</span><span class="p">,</span> <span class="k">const</span> <span class="kt">char</span><span class="o">*</span> <span class="n">fileName</span> <span class="p">)</span> <span class="p">{</span>
<a name="Assert.h-10"></a>        <span class="n">message</span> <span class="o">+=</span> <span class="n">statement</span><span class="p">;</span>
<a name="Assert.h-11"></a>        <span class="n">message</span> <span class="o">+=</span> <span class="s">&quot; failed in function: &quot;</span><span class="p">;</span>
<a name="Assert.h-12"></a>        <span class="n">message</span> <span class="o">+=</span> <span class="n">functionName</span><span class="p">;</span>
<a name="Assert.h-13"></a>        <span class="n">message</span> <span class="o">+=</span> <span class="s">&quot; in file: &quot;</span><span class="p">;</span>
<a name="Assert.h-14"></a>        <span class="n">message</span> <span class="o">+=</span> <span class="n">fileName</span><span class="p">;</span>
<a name="Assert.h-15"></a>    <span class="p">}</span>
<a name="Assert.h-16"></a>
<a name="Assert.h-17"></a>    <span class="n">virtual</span> <span class="k">const</span> <span class="kt">char</span><span class="o">*</span> <span class="n">what</span><span class="p">()</span>  <span class="k">const</span> <span class="n">_GLIBCXX_USE_NOEXCEPT</span> <span class="n">override</span> <span class="p">{</span>
<a name="Assert.h-18"></a>        <span class="k">return</span> <span class="n">message</span><span class="p">.</span><span class="n">c_str</span><span class="p">();</span>
<a name="Assert.h-19"></a>    <span class="p">}</span>
<a name="Assert.h-20"></a>
<a name="Assert.h-21"></a><span class="nl">private</span><span class="p">:</span>
<a name="Assert.h-22"></a>    <span class="n">std</span><span class="o">::</span><span class="n">string</span> <span class="n">message</span><span class="p">;</span>
<a name="Assert.h-23"></a><span class="p">};</span>
<a name="Assert.h-24"></a>
<a name="Assert.h-25"></a><span class="cp">#define assert( x ) \</span>
<a name="Assert.h-26"></a><span class="cp">if( !(x) ) { \</span>
<a name="Assert.h-27"></a><span class="cp">    throw assertion_error( #x,  __FUNCTION__, __FILE__ ); \</span>
<a name="Assert.h-28"></a><span class="cp">}</span>
</pre></div>
</td></tr></table>
    </div>
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
            ...
            [[#hasMultipleHeads]]
              [[#heads]]
                <li class="comprev filter-item">
                  <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/HW8/Assert.h?at=[[safeName]]"
                     title="[[name]]">
                    [[name]] ([[shortChangeset]])
                  </a>
                </li>
            ...
            [[^hasMultipleHeads]]
              <li class="comprev filter-item">
                <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/HW8/Assert.h?at=[[safeName]]" title="[[name]]">
                  [[name]]
                </a>
              </li>
            [[/hasMultipleHeads]]
