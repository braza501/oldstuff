...
<meta name="apitoken" content="{&quot;token&quot;: &quot;B6X-qHYN8g9kJxmpVqzXjRj-QFH1Mkhgt2Gqod6QWPLlfPj95DN4a2-Rw5LvQ-qkPrzdsR9TIEHT9QeTg4udeD4H308y&quot;, &quot;connectionId&quot;: 619065, &quot;expiration&quot;: 1489896132.996932}">
...
<header id="source-path">
    ...
    <div class="secondary-actions">
      <div class="aui-buttons">
          ...
          <a href="/braza501/c-course-hws/src/286c32a03bb5/HW6/SingleLinkedList.h?at=master"
            class="aui-button pjax-trigger" aria-pressed="true">
            Source
          </a>
          <a href="/braza501/c-course-hws/diff/HW6/SingleLinkedList.h?diff2=286c32a03bb5&at=master"
            class="aui-button pjax-trigger"
            title="Diff to previous change">
            Diff
          </a>
          <a href="/braza501/c-course-hws/history-node/286c32a03bb5/HW6/SingleLinkedList.h?at=master"
            class="aui-button pjax-trigger">
            History
          </a>
  ...
  <h1>
        ...
        <a href="/braza501/c-course-hws/src/286c32a03bb5?at=master"
          class="pjax-trigger root" title="braza501/c-course-hws at 286c32a03bb5">C++ Course HWs</a> /
            ...
            <span class="file-name">SingleLinkedList.h</span>
  ...
  <div id="editor-container" class="maskable"
       ...
       data-branch="master"
       data-path="HW6/SingleLinkedList.h"
       data-source-url="/api/internal/repositories/braza501/c-course-hws/src/286c32a03bb586675f981e6fc28c3f6b037a0d61/HW6/SingleLinkedList.h">
  ...
  <span class="aui-icon-dropdown"></span>
          ...
          <a href="/braza501/c-course-hws/full-commit/286c32a03bb5/HW6/SingleLinkedList.h" id="full-commit-link"
        ...
        <div class="secondary">
          ...
          <div class="aui-buttons">
              ...
              <a href="/braza501/c-course-hws/annotate/286c32a03bb586675f981e6fc28c3f6b037a0d61/HW6/SingleLinkedList.h?at=master"
                 class="aui-button aui-button-light pjax-trigger">Blame</a>
              
            
            <a href="/braza501/c-course-hws/raw/286c32a03bb586675f981e6fc28c3f6b037a0d61/HW6/SingleLinkedList.h" class="aui-button aui-button-light">Raw</a>
          </div>
    ...
    <div class="file-source">
      <table class="codehilite highlighttable"><tr><td class="linenos"><div class="linenodiv"><pre><a href="#SingleLinkedList.h-1"> 1</a>
<a href="#SingleLinkedList.h-2"> 2</a>
<a href="#SingleLinkedList.h-3"> 3</a>
<a href="#SingleLinkedList.h-4"> 4</a>
<a href="#SingleLinkedList.h-5"> 5</a>
<a href="#SingleLinkedList.h-6"> 6</a>
<a href="#SingleLinkedList.h-7"> 7</a>
<a href="#SingleLinkedList.h-8"> 8</a>
<a href="#SingleLinkedList.h-9"> 9</a>
<a href="#SingleLinkedList.h-10">10</a>
<a href="#SingleLinkedList.h-11">11</a>
<a href="#SingleLinkedList.h-12">12</a>
<a href="#SingleLinkedList.h-13">13</a>
<a href="#SingleLinkedList.h-14">14</a>
<a href="#SingleLinkedList.h-15">15</a>
<a href="#SingleLinkedList.h-16">16</a>
<a href="#SingleLinkedList.h-17">17</a>
<a href="#SingleLinkedList.h-18">18</a>
<a href="#SingleLinkedList.h-19">19</a>
<a href="#SingleLinkedList.h-20">20</a>
<a href="#SingleLinkedList.h-21">21</a>
<a href="#SingleLinkedList.h-22">22</a>
<a href="#SingleLinkedList.h-23">23</a>
<a href="#SingleLinkedList.h-24">24</a>
<a href="#SingleLinkedList.h-25">25</a>
<a href="#SingleLinkedList.h-26">26</a>
<a href="#SingleLinkedList.h-27">27</a>
<a href="#SingleLinkedList.h-28">28</a>
<a href="#SingleLinkedList.h-29">29</a>
<a href="#SingleLinkedList.h-30">30</a>
<a href="#SingleLinkedList.h-31">31</a>
<a href="#SingleLinkedList.h-32">32</a>
<a href="#SingleLinkedList.h-33">33</a>
<a href="#SingleLinkedList.h-34">34</a>
<a href="#SingleLinkedList.h-35">35</a>
<a href="#SingleLinkedList.h-36">36</a>
<a href="#SingleLinkedList.h-37">37</a>
<a href="#SingleLinkedList.h-38">38</a>
<a href="#SingleLinkedList.h-39">39</a>
<a href="#SingleLinkedList.h-40">40</a>
<a href="#SingleLinkedList.h-41">41</a>
<a href="#SingleLinkedList.h-42">42</a>
<a href="#SingleLinkedList.h-43">43</a>
<a href="#SingleLinkedList.h-44">44</a>
<a href="#SingleLinkedList.h-45">45</a>
<a href="#SingleLinkedList.h-46">46</a>
<a href="#SingleLinkedList.h-47">47</a>
<a href="#SingleLinkedList.h-48">48</a>
<a href="#SingleLinkedList.h-49">49</a>
<a href="#SingleLinkedList.h-50">50</a>
<a href="#SingleLinkedList.h-51">51</a>
<a href="#SingleLinkedList.h-52">52</a>
<a href="#SingleLinkedList.h-53">53</a>
<a href="#SingleLinkedList.h-54">54</a>
<a href="#SingleLinkedList.h-55">55</a>
<a href="#SingleLinkedList.h-56">56</a>
<a href="#SingleLinkedList.h-57">57</a>
<a href="#SingleLinkedList.h-58">58</a>
<a href="#SingleLinkedList.h-59">59</a>
<a href="#SingleLinkedList.h-60">60</a>
<a href="#SingleLinkedList.h-61">61</a>
<a href="#SingleLinkedList.h-62">62</a>
<a href="#SingleLinkedList.h-63">63</a></pre></div></td><td class="code"><div class="codehilite highlight"><pre><span></span><a name="SingleLinkedList.h-1"></a><span class="cp">#pragma once</span>
<a name="SingleLinkedList.h-2"></a>
<a name="SingleLinkedList.h-3"></a><span class="c1">//author : Alexey Bandura</span>
<a name="SingleLinkedList.h-4"></a><span class="c1">// Description : everywhere I use 0-based index logic. e.g DeleteKthElement(1) deletes the second element.</span>
<a name="SingleLinkedList.h-5"></a>
<a name="SingleLinkedList.h-6"></a><span class="k">struct</span> <span class="n">SllNode</span> <span class="p">{</span>
<a name="SingleLinkedList.h-7"></a>    <span class="kt">int</span> <span class="n">value</span><span class="p">;</span>
<a name="SingleLinkedList.h-8"></a>    <span class="n">SllNode</span> <span class="o">*</span><span class="n">next</span><span class="p">;</span>
<a name="SingleLinkedList.h-9"></a>
<a name="SingleLinkedList.h-10"></a>    <span class="n">SllNode</span><span class="p">(</span><span class="kt">int</span> <span class="n">v</span><span class="p">,</span> <span class="n">SllNode</span> <span class="o">*</span><span class="n">next</span> <span class="o">=</span> <span class="n">nullptr</span><span class="p">)</span> <span class="p">{</span>
<a name="SingleLinkedList.h-11"></a>        <span class="n">value</span> <span class="o">=</span> <span class="n">v</span><span class="p">;</span>
<a name="SingleLinkedList.h-12"></a>        <span class="n">this</span><span class="o">-&gt;</span><span class="n">next</span> <span class="o">=</span> <span class="n">next</span><span class="p">;</span>
<a name="SingleLinkedList.h-13"></a>    <span class="p">}</span>
<a name="SingleLinkedList.h-14"></a><span class="p">};</span>
<a name="SingleLinkedList.h-15"></a>
<a name="SingleLinkedList.h-16"></a><span class="n">class</span> <span class="n">SingleLinkedList</span> <span class="p">{</span>
<a name="SingleLinkedList.h-17"></a><span class="nl">public</span><span class="p">:</span>
<a name="SingleLinkedList.h-18"></a>    <span class="n">SingleLinkedList</span><span class="p">();</span>
<a name="SingleLinkedList.h-19"></a>
<a name="SingleLinkedList.h-20"></a>
<a name="SingleLinkedList.h-21"></a>    <span class="n">SingleLinkedList</span><span class="p">(</span><span class="k">const</span> <span class="n">SingleLinkedList</span> <span class="o">&amp;</span><span class="n">temp</span><span class="p">);</span>
<a name="SingleLinkedList.h-22"></a>
<a name="SingleLinkedList.h-23"></a>    <span class="kt">void</span> <span class="n">operator</span><span class="o">=</span><span class="p">(</span><span class="k">const</span> <span class="n">SingleLinkedList</span> <span class="o">&amp;</span><span class="n">temp</span><span class="p">);</span>
<a name="SingleLinkedList.h-24"></a>
<a name="SingleLinkedList.h-25"></a>    <span class="n">friend</span> <span class="n">std</span><span class="o">::</span><span class="n">ostream</span> <span class="o">&amp;</span><span class="n">operator</span><span class="o">&lt;&lt;</span><span class="p">(</span><span class="n">std</span><span class="o">::</span><span class="n">ostream</span> <span class="o">&amp;</span><span class="n">out</span><span class="p">,</span> <span class="k">const</span> <span class="n">SingleLinkedList</span> <span class="o">&amp;</span><span class="n">list</span><span class="p">);</span>
<a name="SingleLinkedList.h-26"></a>
<a name="SingleLinkedList.h-27"></a>    <span class="c1">// Adds one integer to the end of the list</span>
<a name="SingleLinkedList.h-28"></a>    <span class="kt">void</span> <span class="nf">AddToEnd</span><span class="p">(</span><span class="kt">int</span> <span class="n">newValue</span><span class="p">);</span>
<a name="SingleLinkedList.h-29"></a>
<a name="SingleLinkedList.h-30"></a>    <span class="kt">void</span> <span class="nf">AddToFront</span><span class="p">(</span><span class="kt">int</span> <span class="n">newValue</span><span class="p">);</span>
<a name="SingleLinkedList.h-31"></a>
<a name="SingleLinkedList.h-32"></a>    <span class="kt">int</span> <span class="nf">FindElement</span><span class="p">(</span><span class="kt">int</span> <span class="n">elementToFind</span><span class="p">);</span>
<a name="SingleLinkedList.h-33"></a>
<a name="SingleLinkedList.h-34"></a>    <span class="kt">void</span> <span class="nf">AddToPosition</span><span class="p">(</span><span class="kt">int</span> <span class="n">position</span><span class="p">,</span> <span class="kt">int</span> <span class="n">value</span><span class="p">);</span>
<a name="SingleLinkedList.h-35"></a>
<a name="SingleLinkedList.h-36"></a>    <span class="kt">int</span> <span class="nf">GetKthFromTheEnd</span><span class="p">(</span><span class="kt">int</span> <span class="n">k</span><span class="p">);</span>
<a name="SingleLinkedList.h-37"></a>
<a name="SingleLinkedList.h-38"></a>    <span class="kt">int</span> <span class="nf">GetKthFromTheBeginning</span><span class="p">(</span><span class="kt">int</span> <span class="n">k</span><span class="p">);</span>
<a name="SingleLinkedList.h-39"></a>
<a name="SingleLinkedList.h-40"></a>    <span class="kt">void</span> <span class="nf">Revert</span><span class="p">();</span>
<a name="SingleLinkedList.h-41"></a>
<a name="SingleLinkedList.h-42"></a>    <span class="c1">//Sort elements using ins. sort for lists</span>
<a name="SingleLinkedList.h-43"></a>    <span class="kt">void</span> <span class="nf">InsertionSort</span><span class="p">();</span>
<a name="SingleLinkedList.h-44"></a>
<a name="SingleLinkedList.h-45"></a>    <span class="kt">void</span> <span class="nf">AddRandomNumbers</span><span class="p">(</span><span class="kt">int</span> <span class="n">sizeToAdd</span><span class="p">);</span>
<a name="SingleLinkedList.h-46"></a>
<a name="SingleLinkedList.h-47"></a>    <span class="kt">void</span> <span class="nf">DeleteKthElement</span><span class="p">(</span><span class="kt">int</span> <span class="n">k</span><span class="p">);</span>
<a name="SingleLinkedList.h-48"></a>
<a name="SingleLinkedList.h-49"></a>    <span class="c1">// Print all values of the list</span>
<a name="SingleLinkedList.h-50"></a>    <span class="kt">void</span> <span class="nf">Print</span><span class="p">()</span> <span class="k">const</span><span class="p">;</span>
<a name="SingleLinkedList.h-51"></a>
<a name="SingleLinkedList.h-52"></a>    <span class="c1">// Deletes all nodes</span>
<a name="SingleLinkedList.h-53"></a>    <span class="o">~</span><span class="n">SingleLinkedList</span><span class="p">();</span>
<a name="SingleLinkedList.h-54"></a>
<a name="SingleLinkedList.h-55"></a><span class="nl">private</span><span class="p">:</span>
<a name="SingleLinkedList.h-56"></a>    <span class="n">SllNode</span> <span class="o">*</span><span class="n">head</span><span class="p">;</span>
<a name="SingleLinkedList.h-57"></a>    <span class="n">SllNode</span> <span class="o">*</span><span class="n">tail</span><span class="p">;</span>
<a name="SingleLinkedList.h-58"></a>
<a name="SingleLinkedList.h-59"></a>    <span class="c1">//helping function for perfoming insertiong sort.</span>
<a name="SingleLinkedList.h-60"></a>    <span class="kt">void</span> <span class="nf">SortedInsert</span><span class="p">(</span><span class="n">SllNode</span> <span class="o">**</span><span class="p">,</span> <span class="n">SllNode</span> <span class="o">*</span><span class="p">);</span>
<a name="SingleLinkedList.h-61"></a><span class="p">};</span>
<a name="SingleLinkedList.h-62"></a>
<a name="SingleLinkedList.h-63"></a><span class="kt">void</span> <span class="nf">TestSingleLinkedList</span><span class="p">();</span>
</pre></div>
</td></tr></table>
    </div>
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
            ...
            [[#hasMultipleHeads]]
              [[#heads]]
                <li class="comprev filter-item">
                  <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/HW6/SingleLinkedList.h?at=[[safeName]]"
                     title="[[name]]">
                    [[name]] ([[shortChangeset]])
                  </a>
                </li>
            ...
            [[^hasMultipleHeads]]
              <li class="comprev filter-item">
                <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/HW6/SingleLinkedList.h?at=[[safeName]]" title="[[name]]">
                  [[name]]
                </a>
              </li>
            [[/hasMultipleHeads]]
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","queueTime":0,"licenseKey":"a2cef8c3d3","agent":"","transactionName":"Z11RZxdWW0cEVkYLDV4XdUYLVEFdClsdAAtEWkZQDlJBGgRFQhFMQl1DXFcZQ10AQkFYBFlUVlEXWEJHAA==","applicationID":"1841284","errorBeacon":"bam.nr-data.net","applicationTime":156}</script>
</body>
</html>