...
<meta name="apitoken" content="{&quot;token&quot;: &quot;SLI2ZMt2LIklqZE3Mhg4I0mTXpZ6ZHdnjKiUcbONioCUu81ce99e3MVu3Sr2KyFwSqnA939g502sGvVBHgUgPgyKrvDv-w==&quot;, &quot;connectionId&quot;: 619065, &quot;expiration&quot;: 1489897697.731194}">
...
<header id="source-path">
    ...
    <div class="secondary-actions">
      <div class="aui-buttons">
          ...
          <a href="/braza501/c-course-hws/src/286c32a03bb5/assignment%201/1.cpp?at=master"
            class="aui-button pjax-trigger" aria-pressed="true">
            Source
          </a>
          <a href="/braza501/c-course-hws/diff/assignment%201/1.cpp?diff2=286c32a03bb5&at=master"
            class="aui-button pjax-trigger"
            title="Diff to previous change">
            Diff
          </a>
          <a href="/braza501/c-course-hws/history-node/286c32a03bb5/assignment%201/1.cpp?at=master"
            class="aui-button pjax-trigger">
            History
          </a>
  ...
  <h1>
        ...
        <a href="/braza501/c-course-hws/src/286c32a03bb5?at=master"
          class="pjax-trigger root" title="braza501/c-course-hws at 286c32a03bb5">C++ Course HWs</a> /
            ...
            <span class="file-name">1.cpp</span>
  ...
  <div id="editor-container" class="maskable"
       ...
       data-branch="master"
       data-path="assignment 1/1.cpp"
       data-source-url="/api/internal/repositories/braza501/c-course-hws/src/286c32a03bb586675f981e6fc28c3f6b037a0d61/assignment%201/1.cpp">
        ...
        <div class="primary">
          <div class="aui-buttons">
              ...
              <button id="file-history-trigger" class="aui-button aui-button-light changeset-info"
                      ...
                      data-path="assignment%201/1.cpp"
  ...
  <span class="aui-icon-dropdown"></span>
          ...
          <a href="/braza501/c-course-hws/full-commit/286c32a03bb5/assignment%201/1.cpp" id="full-commit-link"
        ...
        <div class="secondary">
          ...
          <div class="aui-buttons">
              ...
              <a href="/braza501/c-course-hws/annotate/286c32a03bb586675f981e6fc28c3f6b037a0d61/assignment%201/1.cpp?at=master"
                 class="aui-button aui-button-light pjax-trigger">Blame</a>
              
            
            <a href="/braza501/c-course-hws/raw/286c32a03bb586675f981e6fc28c3f6b037a0d61/assignment%201/1.cpp" class="aui-button aui-button-light">Raw</a>
          </div>
    ...
    <div class="file-source">
      <table class="codehilite highlighttable"><tr><td class="linenos"><div class="linenodiv"><pre><a href="#1.cpp-1"> 1</a>
<a href="#1.cpp-2"> 2</a>
<a href="#1.cpp-3"> 3</a>
<a href="#1.cpp-4"> 4</a>
<a href="#1.cpp-5"> 5</a>
...
<a href="#1.cpp-8"> 8</a>
<a href="#1.cpp-9"> 9</a>
<a href="#1.cpp-10">10</a>
<a href="#1.cpp-11">11</a>
<a href="#1.cpp-12">12</a>
<a href="#1.cpp-13">13</a>
<a href="#1.cpp-14">14</a>
<a href="#1.cpp-15">15</a>
<a href="#1.cpp-16">16</a>
<a href="#1.cpp-17">17</a>
<a href="#1.cpp-18">18</a>
<a href="#1.cpp-19">19</a>
<a href="#1.cpp-20">20</a>
<a href="#1.cpp-21">21</a>
<a href="#1.cpp-22">22</a>
<a href="#1.cpp-23">23</a></pre></div></td><td class="code"><div class="codehilite highlight"><pre><span></span><a name="1.cpp-1"></a><span class="cp">#include</span> <span class="cpf">&lt;iostream&gt;</span><span class="cp"></span>
<a name="1.cpp-2"></a><span class="cp">#include</span> <span class="cpf">&lt;algorithm&gt;</span><span class="cp"></span>
<a name="1.cpp-3"></a><span class="cp">#include</span> <span class="cpf">&lt;string&gt;</span><span class="cp"></span>
<a name="1.cpp-4"></a><span class="cp">#include</span> <span class="cpf">&lt;ctime&gt;</span><span class="cp"></span>
<a name="1.cpp-5"></a><span class="cp">#include</span> <span class="cpf">&lt;cstdlib&gt;</span><span class="cp"></span>
<a name="1.cpp-6"></a><span class="cp">#include</span> <span class="cpf">&lt;sstream&gt;</span><span class="cp"></span>
<a name="1.cpp-7"></a><span class="cp">#include</span> <span class="cpf">&lt;cmath&gt;</span><span class="cp"></span>
<a name="1.cpp-8"></a><span class="cp">#include</span> <span class="cpf">&lt;cctype&gt;</span><span class="cp"></span>
<a name="1.cpp-9"></a>
<a name="1.cpp-10"></a><span class="kt">int</span> <span class="nf">power</span><span class="p">(</span><span class="kt">int</span> <span class="n">x</span><span class="p">,</span> <span class="kt">int</span> <span class="n">n</span><span class="p">)</span> <span class="p">{</span>
<a name="1.cpp-11"></a>    <span class="kt">int</span> <span class="n">m</span><span class="p">;</span>
<a name="1.cpp-12"></a>    <span class="k">if</span> <span class="p">(</span><span class="n">n</span> <span class="o">==</span> <span class="mi">0</span><span class="p">)</span> <span class="k">return</span> <span class="mi">1</span><span class="p">;</span>
<a name="1.cpp-13"></a>    <span class="k">if</span> <span class="p">(</span><span class="n">n</span> <span class="o">%</span> <span class="mi">2</span> <span class="o">==</span> <span class="mi">0</span><span class="p">)</span> <span class="p">{</span>
<a name="1.cpp-14"></a>        <span class="n">m</span> <span class="o">=</span> <span class="n">power</span><span class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">n</span> <span class="o">/</span> <span class="mi">2</span><span class="p">);</span>
<a name="1.cpp-15"></a>        <span class="k">return</span> <span class="n">m</span> <span class="o">*</span> <span class="n">m</span><span class="p">;</span>
<a name="1.cpp-16"></a>    <span class="p">}</span> <span class="k">else</span> <span class="k">return</span> <span class="n">x</span> <span class="o">*</span> <span class="n">power</span><span class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">n</span> <span class="o">-</span> <span class="mi">1</span><span class="p">);</span>
<a name="1.cpp-17"></a><span class="p">}</span>
<a name="1.cpp-18"></a>
<a name="1.cpp-19"></a><span class="kt">int</span> <span class="nf">main</span><span class="p">()</span> <span class="p">{</span>
<a name="1.cpp-20"></a>
<a name="1.cpp-21"></a>    <span class="n">std</span><span class="o">::</span><span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="n">power</span><span class="p">(</span><span class="mi">2</span><span class="p">,</span> <span class="mi">4</span><span class="p">);</span>
<a name="1.cpp-22"></a>    <span class="k">return</span> <span class="mi">0</span><span class="p">;</span>
<a name="1.cpp-23"></a><span class="p">}</span>
</pre></div>
</td></tr></table>
    </div>
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
            ...
            [[#hasMultipleHeads]]
              [[#heads]]
                <li class="comprev filter-item">
                  <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/assignment 1/1.cpp?at=[[safeName]]"
                     title="[[name]]">
                    [[name]] ([[shortChangeset]])
                  </a>
                </li>
            ...
            [[^hasMultipleHeads]]
              <li class="comprev filter-item">
                <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/assignment 1/1.cpp?at=[[safeName]]" title="[[name]]">
                  [[name]]
                </a>
              </li>
            [[/hasMultipleHeads]]
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","queueTime":0,"licenseKey":"a2cef8c3d3","agent":"","transactionName":"Z11RZxdWW0cEVkYLDV4XdUYLVEFdClsdAAtEWkZQDlJBGgRFQhFMQl1DXFcZQ10AQkFYBFlUVlEXWEJHAA==","applicationID":"1841284","errorBeacon":"bam.nr-data.net","applicationTime":272}</script>
</body>
</html>