...
<meta name="apitoken" content="{&quot;token&quot;: &quot;miw9emoNwfRe4c3fpw_nNzCqp0u-F_I2Z-peQv6QqLT5ili5CrJJkxbsBvQrwLK_hXe0x1llf7mV_22pH5qsmil91zoU6g==&quot;, &quot;connectionId&quot;: 619065, &quot;expiration&quot;: 1489897711.613028}">
...
<header id="source-path">
    ...
    <div class="secondary-actions">
      <div class="aui-buttons">
          ...
          <a href="/braza501/c-course-hws/src/286c32a03bb5/assignment%201/6.cpp?at=master"
            class="aui-button pjax-trigger" aria-pressed="true">
            Source
          </a>
          <a href="/braza501/c-course-hws/diff/assignment%201/6.cpp?diff2=286c32a03bb5&at=master"
            class="aui-button pjax-trigger"
            title="Diff to previous change">
            Diff
          </a>
          <a href="/braza501/c-course-hws/history-node/286c32a03bb5/assignment%201/6.cpp?at=master"
            class="aui-button pjax-trigger">
            History
          </a>
  ...
  <h1>
        ...
        <a href="/braza501/c-course-hws/src/286c32a03bb5?at=master"
          class="pjax-trigger root" title="braza501/c-course-hws at 286c32a03bb5">C++ Course HWs</a> /
            ...
            <span class="file-name">6.cpp</span>
  ...
  <div id="editor-container" class="maskable"
       ...
       data-branch="master"
       data-path="assignment 1/6.cpp"
       data-source-url="/api/internal/repositories/braza501/c-course-hws/src/286c32a03bb586675f981e6fc28c3f6b037a0d61/assignment%201/6.cpp">
        ...
        <div class="primary">
          <div class="aui-buttons">
              ...
              <button id="file-history-trigger" class="aui-button aui-button-light changeset-info"
                      ...
                      data-path="assignment%201/6.cpp"
  ...
  <span class="aui-icon-dropdown"></span>
          ...
          <a href="/braza501/c-course-hws/full-commit/286c32a03bb5/assignment%201/6.cpp" id="full-commit-link"
        ...
        <div class="secondary">
          ...
          <div class="aui-buttons">
              ...
              <a href="/braza501/c-course-hws/annotate/286c32a03bb586675f981e6fc28c3f6b037a0d61/assignment%201/6.cpp?at=master"
                 class="aui-button aui-button-light pjax-trigger">Blame</a>
              
            
            <a href="/braza501/c-course-hws/raw/286c32a03bb586675f981e6fc28c3f6b037a0d61/assignment%201/6.cpp" class="aui-button aui-button-light">Raw</a>
          </div>
    ...
    <div class="file-source">
      <table class="codehilite highlighttable"><tr><td class="linenos"><div class="linenodiv"><pre><a href="#6.cpp-1"> 1</a>
<a href="#6.cpp-2"> 2</a>
<a href="#6.cpp-3"> 3</a>
<a href="#6.cpp-4"> 4</a>
<a href="#6.cpp-5"> 5</a>
...
<a href="#6.cpp-8"> 8</a>
<a href="#6.cpp-9"> 9</a>
<a href="#6.cpp-10">10</a>
<a href="#6.cpp-11">11</a>
<a href="#6.cpp-12">12</a>
<a href="#6.cpp-13">13</a>
<a href="#6.cpp-14">14</a>
<a href="#6.cpp-15">15</a>
<a href="#6.cpp-16">16</a>
<a href="#6.cpp-17">17</a>
<a href="#6.cpp-18">18</a>
<a href="#6.cpp-19">19</a>
<a href="#6.cpp-20">20</a>
<a href="#6.cpp-21">21</a>
<a href="#6.cpp-22">22</a>
<a href="#6.cpp-23">23</a>
<a href="#6.cpp-24">24</a>
<a href="#6.cpp-25">25</a>
<a href="#6.cpp-26">26</a>
<a href="#6.cpp-27">27</a>
<a href="#6.cpp-28">28</a>
<a href="#6.cpp-29">29</a>
<a href="#6.cpp-30">30</a>
<a href="#6.cpp-31">31</a>
<a href="#6.cpp-32">32</a>
<a href="#6.cpp-33">33</a>
<a href="#6.cpp-34">34</a>
<a href="#6.cpp-35">35</a>
<a href="#6.cpp-36">36</a>
<a href="#6.cpp-37">37</a>
<a href="#6.cpp-38">38</a>
<a href="#6.cpp-39">39</a>
<a href="#6.cpp-40">40</a>
<a href="#6.cpp-41">41</a>
<a href="#6.cpp-42">42</a>
<a href="#6.cpp-43">43</a>
<a href="#6.cpp-44">44</a>
<a href="#6.cpp-45">45</a>
<a href="#6.cpp-46">46</a>
<a href="#6.cpp-47">47</a>
<a href="#6.cpp-48">48</a>
<a href="#6.cpp-49">49</a>
<a href="#6.cpp-50">50</a>
<a href="#6.cpp-51">51</a>
<a href="#6.cpp-52">52</a>
<a href="#6.cpp-53">53</a>
<a href="#6.cpp-54">54</a>
<a href="#6.cpp-55">55</a>
<a href="#6.cpp-56">56</a>
<a href="#6.cpp-57">57</a>
<a href="#6.cpp-58">58</a>
<a href="#6.cpp-59">59</a>
<a href="#6.cpp-60">60</a>
<a href="#6.cpp-61">61</a>
<a href="#6.cpp-62">62</a>
<a href="#6.cpp-63">63</a>
<a href="#6.cpp-64">64</a>
<a href="#6.cpp-65">65</a>
<a href="#6.cpp-66">66</a>
<a href="#6.cpp-67">67</a>
<a href="#6.cpp-68">68</a>
<a href="#6.cpp-69">69</a>
<a href="#6.cpp-70">70</a>
<a href="#6.cpp-71">71</a>
<a href="#6.cpp-72">72</a>
<a href="#6.cpp-73">73</a>
<a href="#6.cpp-74">74</a>
<a href="#6.cpp-75">75</a>
<a href="#6.cpp-76">76</a>
<a href="#6.cpp-77">77</a>
<a href="#6.cpp-78">78</a>
<a href="#6.cpp-79">79</a>
<a href="#6.cpp-80">80</a></pre></div></td><td class="code"><div class="codehilite highlight"><pre><span></span><a name="6.cpp-1"></a><span class="cp">#include</span> <span class="cpf">&lt;iostream&gt;</span><span class="cp"></span>
<a name="6.cpp-2"></a>
<a name="6.cpp-3"></a><span class="k">using</span> <span class="k">namespace</span> <span class="n">std</span><span class="p">;</span>
<a name="6.cpp-4"></a>
<a name="6.cpp-5"></a><span class="kt">int</span> <span class="nf">countUnique</span><span class="p">(</span><span class="kt">int</span> <span class="n">array</span><span class="p">[],</span> <span class="kt">int</span> <span class="n">size</span><span class="p">)</span> <span class="p">{</span>
<a name="6.cpp-6"></a>
<a name="6.cpp-7"></a>    <span class="kt">int</span> <span class="n">count</span> <span class="o">=</span> <span class="mi">1</span><span class="p">;</span>
<a name="6.cpp-8"></a>    <span class="k">for</span> <span class="p">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">size</span> <span class="o">-</span> <span class="mi">1</span><span class="p">;</span> <span class="n">i</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span>
<a name="6.cpp-9"></a>        <span class="k">if</span> <span class="p">(</span><span class="n">array</span><span class="p">[</span><span class="n">i</span><span class="p">]</span> <span class="o">!=</span> <span class="n">array</span><span class="p">[</span><span class="n">i</span> <span class="o">+</span> <span class="mi">1</span><span class="p">])</span> <span class="p">{</span>
<a name="6.cpp-10"></a>            <span class="n">count</span><span class="o">++</span><span class="p">;</span>
<a name="6.cpp-11"></a>        <span class="p">}</span>
<a name="6.cpp-12"></a>    <span class="p">}</span>
<a name="6.cpp-13"></a>    <span class="k">return</span> <span class="n">count</span><span class="p">;</span>
<a name="6.cpp-14"></a><span class="p">}</span>
<a name="6.cpp-15"></a>
<a name="6.cpp-16"></a><span class="kt">void</span> <span class="nf">sort</span><span class="p">(</span><span class="kt">int</span> <span class="o">*</span><span class="p">,</span> <span class="kt">int</span> <span class="o">*</span><span class="p">,</span> <span class="kt">int</span><span class="p">,</span> <span class="kt">int</span><span class="p">);</span>
<a name="6.cpp-17"></a>
<a name="6.cpp-18"></a><span class="kt">void</span> <span class="nf">merge</span><span class="p">(</span><span class="kt">int</span> <span class="o">*</span><span class="p">,</span> <span class="kt">int</span> <span class="o">*</span><span class="p">,</span> <span class="kt">int</span><span class="p">,</span> <span class="kt">int</span><span class="p">,</span> <span class="kt">int</span><span class="p">);</span>
<a name="6.cpp-19"></a><span class="kt">void</span> <span class="nf">MergeSort</span><span class="p">(</span><span class="kt">int</span> <span class="o">*</span><span class="n">array</span><span class="p">,</span> <span class="kt">int</span> <span class="n">size</span><span class="p">)</span> <span class="p">{</span>
<a name="6.cpp-20"></a>    <span class="kt">int</span> <span class="n">aux</span><span class="p">[</span><span class="n">size</span><span class="p">];</span>
<a name="6.cpp-21"></a>    <span class="n">sort</span><span class="p">(</span><span class="n">array</span><span class="p">,</span> <span class="n">aux</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="n">size</span> <span class="o">-</span> <span class="mi">1</span><span class="p">);</span>
<a name="6.cpp-22"></a><span class="p">}</span>
<a name="6.cpp-23"></a>
<a name="6.cpp-24"></a><span class="kt">void</span> <span class="nf">sort</span><span class="p">(</span><span class="kt">int</span> <span class="o">*</span><span class="n">a</span><span class="p">,</span> <span class="kt">int</span> <span class="o">*</span><span class="n">aux</span><span class="p">,</span> <span class="kt">int</span> <span class="n">lo</span><span class="p">,</span> <span class="kt">int</span> <span class="n">hi</span><span class="p">)</span> <span class="p">{</span>
<a name="6.cpp-25"></a>    <span class="k">if</span> <span class="p">(</span><span class="n">hi</span> <span class="o">&lt;=</span> <span class="n">lo</span><span class="p">)</span> <span class="k">return</span><span class="p">;</span>
<a name="6.cpp-26"></a>    <span class="kt">int</span> <span class="n">mid</span> <span class="o">=</span> <span class="n">lo</span> <span class="o">+</span> <span class="p">(</span><span class="n">hi</span> <span class="o">-</span> <span class="n">lo</span><span class="p">)</span> <span class="o">/</span> <span class="mi">2</span><span class="p">;</span>
<a name="6.cpp-27"></a>    <span class="n">sort</span><span class="p">(</span><span class="n">a</span><span class="p">,</span> <span class="n">aux</span><span class="p">,</span> <span class="n">lo</span><span class="p">,</span> <span class="n">mid</span><span class="p">);</span>
<a name="6.cpp-28"></a>    <span class="n">sort</span><span class="p">(</span><span class="n">a</span><span class="p">,</span> <span class="n">aux</span><span class="p">,</span> <span class="n">mid</span> <span class="o">+</span> <span class="mi">1</span><span class="p">,</span> <span class="n">hi</span><span class="p">);</span>
<a name="6.cpp-29"></a>    <span class="n">merge</span><span class="p">(</span><span class="n">a</span><span class="p">,</span> <span class="n">aux</span><span class="p">,</span> <span class="n">lo</span><span class="p">,</span> <span class="n">mid</span><span class="p">,</span> <span class="n">hi</span><span class="p">);</span>
<a name="6.cpp-30"></a><span class="p">}</span>
<a name="6.cpp-31"></a>
<a name="6.cpp-32"></a><span class="kt">void</span> <span class="nf">merge</span><span class="p">(</span><span class="kt">int</span> <span class="o">*</span><span class="n">a</span><span class="p">,</span> <span class="kt">int</span> <span class="o">*</span><span class="n">aux</span><span class="p">,</span> <span class="kt">int</span> <span class="n">lo</span><span class="p">,</span> <span class="kt">int</span> <span class="n">mid</span><span class="p">,</span> <span class="kt">int</span> <span class="n">hi</span><span class="p">)</span> <span class="p">{</span>
<a name="6.cpp-33"></a>
<a name="6.cpp-34"></a>    <span class="k">for</span> <span class="p">(</span><span class="kt">int</span> <span class="n">k</span> <span class="o">=</span> <span class="n">lo</span><span class="p">;</span> <span class="n">k</span> <span class="o">&lt;=</span> <span class="n">hi</span><span class="p">;</span> <span class="n">k</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span>
<a name="6.cpp-35"></a>        <span class="n">aux</span><span class="p">[</span><span class="n">k</span><span class="p">]</span> <span class="o">=</span> <span class="n">a</span><span class="p">[</span><span class="n">k</span><span class="p">];</span>
<a name="6.cpp-36"></a>    <span class="p">}</span>
<a name="6.cpp-37"></a>
<a name="6.cpp-38"></a>    <span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="n">lo</span><span class="p">,</span> <span class="n">j</span> <span class="o">=</span> <span class="n">mid</span> <span class="o">+</span> <span class="mi">1</span><span class="p">;</span>
<a name="6.cpp-39"></a>    <span class="k">for</span> <span class="p">(</span><span class="kt">int</span> <span class="n">k</span> <span class="o">=</span> <span class="n">lo</span><span class="p">;</span> <span class="n">k</span> <span class="o">&lt;=</span> <span class="n">hi</span><span class="p">;</span> <span class="n">k</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span>
<a name="6.cpp-40"></a>        <span class="k">if</span> <span class="p">(</span><span class="n">i</span> <span class="o">&gt;</span> <span class="n">mid</span><span class="p">)</span> <span class="n">a</span><span class="p">[</span><span class="n">k</span><span class="p">]</span> <span class="o">=</span> <span class="n">aux</span><span class="p">[</span><span class="n">j</span><span class="o">++</span><span class="p">];</span>
<a name="6.cpp-41"></a>        <span class="k">else</span> <span class="k">if</span> <span class="p">(</span><span class="n">j</span> <span class="o">&gt;</span> <span class="n">hi</span><span class="p">)</span> <span class="n">a</span><span class="p">[</span><span class="n">k</span><span class="p">]</span> <span class="o">=</span> <span class="n">aux</span><span class="p">[</span><span class="n">i</span><span class="o">++</span><span class="p">];</span>
<a name="6.cpp-42"></a>        <span class="k">else</span> <span class="k">if</span> <span class="p">(</span><span class="n">aux</span><span class="p">[</span><span class="n">j</span><span class="p">]</span> <span class="o">&lt;</span> <span class="n">aux</span><span class="p">[</span><span class="n">i</span><span class="p">])</span> <span class="n">a</span><span class="p">[</span><span class="n">k</span><span class="p">]</span> <span class="o">=</span> <span class="n">aux</span><span class="p">[</span><span class="n">j</span><span class="o">++</span><span class="p">];</span>
<a name="6.cpp-43"></a>        <span class="k">else</span> <span class="n">a</span><span class="p">[</span><span class="n">k</span><span class="p">]</span> <span class="o">=</span> <span class="n">aux</span><span class="p">[</span><span class="n">i</span><span class="o">++</span><span class="p">];</span>
<a name="6.cpp-44"></a>    <span class="p">}</span>
<a name="6.cpp-45"></a><span class="p">}</span>
<a name="6.cpp-46"></a><span class="kt">int</span> <span class="nf">Find</span><span class="p">(</span><span class="kt">int</span> <span class="n">arr1</span><span class="p">[],</span> <span class="kt">int</span> <span class="n">size_a</span><span class="p">,</span> <span class="kt">int</span> <span class="n">arr2</span><span class="p">[],</span> <span class="kt">int</span> <span class="n">size_b</span><span class="p">)</span> <span class="p">{</span>
<a name="6.cpp-47"></a>    <span class="kt">int</span> <span class="n">pointer1</span><span class="p">,</span> <span class="n">pointer2</span><span class="p">;</span>
<a name="6.cpp-48"></a>    <span class="n">pointer1</span> <span class="o">=</span> <span class="n">pointer2</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
<a name="6.cpp-49"></a>    <span class="kt">int</span> <span class="n">count</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
<a name="6.cpp-50"></a>
<a name="6.cpp-51"></a>    <span class="k">while</span> <span class="p">(</span><span class="n">pointer1</span> <span class="o">&lt;</span> <span class="n">size_a</span> <span class="o">&amp;&amp;</span> <span class="n">pointer2</span> <span class="o">&lt;</span> <span class="n">size_b</span><span class="p">)</span> <span class="p">{</span>
<a name="6.cpp-52"></a>        <span class="k">if</span> <span class="p">(</span><span class="n">arr1</span><span class="p">[</span><span class="n">pointer1</span><span class="p">]</span> <span class="o">==</span> <span class="n">arr2</span><span class="p">[</span><span class="n">pointer2</span><span class="p">])</span> <span class="p">{</span>
<a name="6.cpp-53"></a>            <span class="n">count</span><span class="o">++</span><span class="p">;</span>
<a name="6.cpp-54"></a>            <span class="n">pointer2</span><span class="o">++</span><span class="p">;</span>
<a name="6.cpp-55"></a>        <span class="p">}</span> <span class="k">else</span> <span class="k">if</span> <span class="p">(</span><span class="n">arr1</span><span class="p">[</span><span class="n">pointer1</span><span class="p">]</span> <span class="o">&lt;</span> <span class="n">arr2</span><span class="p">[</span><span class="n">pointer2</span><span class="p">])</span> <span class="p">{</span>
<a name="6.cpp-56"></a>            <span class="n">pointer1</span><span class="o">++</span><span class="p">;</span>
<a name="6.cpp-57"></a>        <span class="p">}</span> <span class="k">else</span> <span class="p">{</span>
<a name="6.cpp-58"></a>            <span class="n">pointer2</span><span class="o">++</span><span class="p">;</span>
<a name="6.cpp-59"></a>        <span class="p">}</span>
<a name="6.cpp-60"></a>    <span class="p">}</span>
<a name="6.cpp-61"></a>    <span class="k">return</span> <span class="n">count</span><span class="p">;</span>
<a name="6.cpp-62"></a><span class="p">}</span>
<a name="6.cpp-63"></a><span class="kt">bool</span> <span class="nf">set_equality</span><span class="p">(</span><span class="kt">int</span> <span class="n">arr1</span><span class="p">[],</span> <span class="kt">int</span> <span class="n">size_a</span><span class="p">,</span> <span class="kt">int</span> <span class="n">arr2</span><span class="p">[],</span> <span class="kt">int</span> <span class="n">size_b</span><span class="p">){</span>
<a name="6.cpp-64"></a>
<a name="6.cpp-65"></a>    <span class="n">MergeSort</span><span class="p">(</span><span class="n">arr1</span><span class="p">,</span> <span class="n">size_a</span><span class="p">);</span>
<a name="6.cpp-66"></a>    <span class="n">MergeSort</span><span class="p">(</span><span class="n">arr2</span><span class="p">,</span> <span class="n">size_b</span><span class="p">);</span>
<a name="6.cpp-67"></a>    <span class="kt">int</span> <span class="n">n</span> <span class="o">=</span> <span class="n">countUnique</span><span class="p">(</span><span class="n">arr1</span><span class="p">,</span> <span class="n">size_a</span><span class="p">);</span>
<a name="6.cpp-68"></a>    <span class="kt">int</span> <span class="n">m</span> <span class="o">=</span> <span class="n">countUnique</span><span class="p">(</span><span class="n">arr2</span><span class="p">,</span> <span class="n">size_b</span><span class="p">);</span>
<a name="6.cpp-69"></a> 
<a name="6.cpp-70"></a>    <span class="k">return</span> <span class="p">(</span><span class="n">m</span> <span class="o">==</span> <span class="n">n</span> <span class="o">&amp;&amp;</span> <span class="n">m</span> <span class="o">==</span> <span class="n">Find</span><span class="p">(</span><span class="n">arr1</span><span class="p">,</span><span class="n">size_a</span><span class="p">,</span><span class="n">arr2</span><span class="p">,</span><span class="n">size_b</span><span class="p">));</span>
<a name="6.cpp-71"></a>     
<a name="6.cpp-72"></a><span class="p">}</span>
<a name="6.cpp-73"></a>
<a name="6.cpp-74"></a>
<a name="6.cpp-75"></a><span class="kt">int</span> <span class="nf">main</span><span class="p">()</span> <span class="p">{</span>
<a name="6.cpp-76"></a>    <span class="kt">int</span> <span class="n">arr1</span><span class="p">[]</span> <span class="o">=</span> <span class="p">{</span><span class="mi">3</span><span class="p">,</span> <span class="mi">2</span><span class="p">,</span> <span class="mi">1</span><span class="p">,</span> <span class="mi">1</span><span class="p">,</span> <span class="mi">2</span><span class="p">};</span>
<a name="6.cpp-77"></a>    <span class="kt">int</span> <span class="n">arr2</span><span class="p">[]</span> <span class="o">=</span> <span class="p">{</span><span class="mi">1</span><span class="p">,</span> <span class="mi">2</span><span class="p">,</span> <span class="mi">3</span><span class="p">};</span>
<a name="6.cpp-78"></a>    <span class="n">cout</span><span class="o">&lt;&lt;</span><span class="n">std</span><span class="o">::</span><span class="n">boolalpha</span><span class="o">&lt;&lt;</span><span class="n">set_equality</span><span class="p">(</span><span class="n">arr1</span><span class="p">,</span> <span class="mi">5</span><span class="p">,</span> <span class="n">arr2</span><span class="p">,</span> <span class="mi">3</span><span class="p">);</span>
<a name="6.cpp-79"></a>    <span class="k">return</span> <span class="mi">0</span><span class="p">;</span>
<a name="6.cpp-80"></a><span class="p">}</span>
</pre></div>
</td></tr></table>
    </div>
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
            ...
            [[#hasMultipleHeads]]
              [[#heads]]
                <li class="comprev filter-item">
                  <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/assignment 1/6.cpp?at=[[safeName]]"
                     title="[[name]]">
                    [[name]] ([[shortChangeset]])
                  </a>
                </li>
            ...
            [[^hasMultipleHeads]]
              <li class="comprev filter-item">
                <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/assignment 1/6.cpp?at=[[safeName]]" title="[[name]]">
                  [[name]]
                </a>
              </li>
            [[/hasMultipleHeads]]
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","queueTime":0,"licenseKey":"a2cef8c3d3","agent":"","transactionName":"Z11RZxdWW0cEVkYLDV4XdUYLVEFdClsdAAtEWkZQDlJBGgRFQhFMQl1DXFcZQ10AQkFYBFlUVlEXWEJHAA==","applicationID":"1841284","errorBeacon":"bam.nr-data.net","applicationTime":169}</script>
</body>
</html>