...
<meta name="apitoken" content="{&quot;token&quot;: &quot;KJtEInfYIVt15bHB3mW7QIIFhM5N5z0fLUDeZXyklukmWSgxQenEWZLDgUll8nDeHRb1blY7mL_V2Jz4-LSU6_Dz0WhJYA==&quot;, &quot;connectionId&quot;: 619065, &quot;expiration&quot;: 1489897741.926155}">
...
<header id="source-path">
    ...
    <div class="secondary-actions">
      <div class="aui-buttons">
          ...
          <a href="/braza501/c-course-hws/src/286c32a03bb5/assignment%201/3.cpp?at=master"
            class="aui-button pjax-trigger" aria-pressed="true">
            Source
          </a>
          <a href="/braza501/c-course-hws/diff/assignment%201/3.cpp?diff2=286c32a03bb5&at=master"
            class="aui-button pjax-trigger"
            title="Diff to previous change">
            Diff
          </a>
          <a href="/braza501/c-course-hws/history-node/286c32a03bb5/assignment%201/3.cpp?at=master"
            class="aui-button pjax-trigger">
            History
          </a>
  ...
  <h1>
        ...
        <a href="/braza501/c-course-hws/src/286c32a03bb5?at=master"
          class="pjax-trigger root" title="braza501/c-course-hws at 286c32a03bb5">C++ Course HWs</a> /
            ...
            <span class="file-name">3.cpp</span>
  ...
  <div id="editor-container" class="maskable"
       ...
       data-branch="master"
       data-path="assignment 1/3.cpp"
       data-source-url="/api/internal/repositories/braza501/c-course-hws/src/286c32a03bb586675f981e6fc28c3f6b037a0d61/assignment%201/3.cpp">
        ...
        <div class="primary">
          <div class="aui-buttons">
              ...
              <button id="file-history-trigger" class="aui-button aui-button-light changeset-info"
                      ...
                      data-path="assignment%201/3.cpp"
  ...
  <span class="aui-icon-dropdown"></span>
          ...
          <a href="/braza501/c-course-hws/full-commit/286c32a03bb5/assignment%201/3.cpp" id="full-commit-link"
        ...
        <div class="secondary">
          ...
          <div class="aui-buttons">
              ...
              <a href="/braza501/c-course-hws/annotate/286c32a03bb586675f981e6fc28c3f6b037a0d61/assignment%201/3.cpp?at=master"
                 class="aui-button aui-button-light pjax-trigger">Blame</a>
              
            
            <a href="/braza501/c-course-hws/raw/286c32a03bb586675f981e6fc28c3f6b037a0d61/assignment%201/3.cpp" class="aui-button aui-button-light">Raw</a>
          </div>
    ...
    <div class="file-source">
      <table class="codehilite highlighttable"><tr><td class="linenos"><div class="linenodiv"><pre><a href="#3.cpp-1"> 1</a>
<a href="#3.cpp-2"> 2</a>
<a href="#3.cpp-3"> 3</a>
<a href="#3.cpp-4"> 4</a>
<a href="#3.cpp-5"> 5</a>
...
<a href="#3.cpp-8"> 8</a>
<a href="#3.cpp-9"> 9</a>
<a href="#3.cpp-10">10</a>
<a href="#3.cpp-11">11</a>
<a href="#3.cpp-12">12</a>
<a href="#3.cpp-13">13</a>
<a href="#3.cpp-14">14</a>
<a href="#3.cpp-15">15</a>
<a href="#3.cpp-16">16</a>
<a href="#3.cpp-17">17</a>
<a href="#3.cpp-18">18</a>
<a href="#3.cpp-19">19</a>
<a href="#3.cpp-20">20</a>
<a href="#3.cpp-21">21</a>
<a href="#3.cpp-22">22</a>
<a href="#3.cpp-23">23</a>
<a href="#3.cpp-24">24</a>
<a href="#3.cpp-25">25</a>
<a href="#3.cpp-26">26</a>
<a href="#3.cpp-27">27</a>
<a href="#3.cpp-28">28</a>
<a href="#3.cpp-29">29</a>
<a href="#3.cpp-30">30</a>
<a href="#3.cpp-31">31</a>
<a href="#3.cpp-32">32</a>
<a href="#3.cpp-33">33</a>
<a href="#3.cpp-34">34</a>
<a href="#3.cpp-35">35</a>
<a href="#3.cpp-36">36</a>
<a href="#3.cpp-37">37</a>
<a href="#3.cpp-38">38</a>
<a href="#3.cpp-39">39</a>
<a href="#3.cpp-40">40</a>
<a href="#3.cpp-41">41</a>
<a href="#3.cpp-42">42</a>
<a href="#3.cpp-43">43</a>
<a href="#3.cpp-44">44</a>
<a href="#3.cpp-45">45</a>
<a href="#3.cpp-46">46</a>
<a href="#3.cpp-47">47</a>
<a href="#3.cpp-48">48</a>
<a href="#3.cpp-49">49</a>
<a href="#3.cpp-50">50</a>
<a href="#3.cpp-51">51</a>
<a href="#3.cpp-52">52</a>
<a href="#3.cpp-53">53</a>
<a href="#3.cpp-54">54</a>
<a href="#3.cpp-55">55</a></pre></div></td><td class="code"><div class="codehilite highlight"><pre><span></span><a name="3.cpp-1"></a><span class="cp">#include</span> <span class="cpf">&lt;iostream&gt;</span><span class="cp"></span>
<a name="3.cpp-2"></a>
<a name="3.cpp-3"></a><span class="kt">void</span> <span class="nf">spiralPrint</span><span class="p">(</span><span class="kt">int</span> <span class="n">m</span><span class="p">,</span> <span class="kt">int</span> <span class="n">n</span><span class="p">,</span> <span class="kt">int</span> <span class="o">**</span><span class="n">a</span><span class="p">)</span> <span class="p">{</span>
<a name="3.cpp-4"></a>    <span class="kt">int</span> <span class="n">i</span><span class="p">,</span> <span class="n">k</span> <span class="o">=</span> <span class="mi">0</span><span class="p">,</span> <span class="n">l</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
<a name="3.cpp-5"></a>    <span class="kt">int</span> <span class="n">number</span> <span class="o">=</span> <span class="n">n</span> <span class="o">*</span> <span class="n">m</span> <span class="o">-</span> <span class="mi">1</span><span class="p">;</span>
<a name="3.cpp-6"></a>
<a name="3.cpp-7"></a>    <span class="k">while</span> <span class="p">(</span><span class="n">k</span> <span class="o">&lt;</span> <span class="n">m</span> <span class="o">&amp;&amp;</span> <span class="n">l</span> <span class="o">&lt;</span> <span class="n">n</span><span class="p">)</span> <span class="p">{</span>
<a name="3.cpp-8"></a>
<a name="3.cpp-9"></a>        <span class="k">for</span> <span class="p">(</span><span class="n">i</span> <span class="o">=</span> <span class="n">k</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">m</span><span class="p">;</span> <span class="o">++</span><span class="n">i</span><span class="p">)</span> <span class="p">{</span>
<a name="3.cpp-10"></a>            <span class="n">a</span><span class="p">[</span><span class="n">i</span><span class="p">][</span><span class="n">n</span> <span class="o">-</span> <span class="mi">1</span><span class="p">]</span> <span class="o">=</span> <span class="n">number</span><span class="o">--</span><span class="p">;</span>
<a name="3.cpp-11"></a>        <span class="p">}</span>
<a name="3.cpp-12"></a>        <span class="n">n</span><span class="o">--</span><span class="p">;</span>
<a name="3.cpp-13"></a>
<a name="3.cpp-14"></a>        <span class="k">if</span> <span class="p">(</span><span class="n">k</span> <span class="o">&lt;</span> <span class="n">m</span><span class="p">)</span> <span class="p">{</span>
<a name="3.cpp-15"></a>            <span class="k">for</span> <span class="p">(</span><span class="n">i</span> <span class="o">=</span> <span class="n">n</span> <span class="o">-</span> <span class="mi">1</span><span class="p">;</span> <span class="n">i</span> <span class="o">&gt;=</span> <span class="n">l</span><span class="p">;</span> <span class="o">--</span><span class="n">i</span><span class="p">)</span> <span class="p">{</span>
<a name="3.cpp-16"></a>                <span class="n">a</span><span class="p">[</span><span class="n">m</span> <span class="o">-</span> <span class="mi">1</span><span class="p">][</span><span class="n">i</span><span class="p">]</span> <span class="o">=</span> <span class="n">number</span><span class="o">--</span><span class="p">;</span>
<a name="3.cpp-17"></a>            <span class="p">}</span>
<a name="3.cpp-18"></a>            <span class="n">m</span><span class="o">--</span><span class="p">;</span>
<a name="3.cpp-19"></a>        <span class="p">}</span>
<a name="3.cpp-20"></a>        <span class="k">if</span> <span class="p">(</span><span class="n">l</span> <span class="o">&lt;</span> <span class="n">n</span><span class="p">)</span> <span class="p">{</span>
<a name="3.cpp-21"></a>            <span class="k">for</span> <span class="p">(</span><span class="n">i</span> <span class="o">=</span> <span class="n">m</span> <span class="o">-</span> <span class="mi">1</span><span class="p">;</span> <span class="n">i</span> <span class="o">&gt;=</span> <span class="n">k</span><span class="p">;</span> <span class="o">--</span><span class="n">i</span><span class="p">)</span> <span class="p">{</span>
<a name="3.cpp-22"></a>                <span class="n">a</span><span class="p">[</span><span class="n">i</span><span class="p">][</span><span class="n">l</span><span class="p">]</span> <span class="o">=</span> <span class="n">number</span><span class="o">--</span><span class="p">;</span>
<a name="3.cpp-23"></a>            <span class="p">}</span>
<a name="3.cpp-24"></a>            <span class="n">l</span><span class="o">++</span><span class="p">;</span>
<a name="3.cpp-25"></a>            <span class="k">for</span> <span class="p">(</span><span class="n">i</span> <span class="o">=</span> <span class="n">l</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">n</span><span class="p">;</span> <span class="o">++</span><span class="n">i</span><span class="p">)</span> <span class="p">{</span>
<a name="3.cpp-26"></a>                <span class="n">a</span><span class="p">[</span><span class="n">k</span><span class="p">][</span><span class="n">i</span><span class="p">]</span> <span class="o">=</span> <span class="n">number</span><span class="o">--</span><span class="p">;</span>
<a name="3.cpp-27"></a>            <span class="p">}</span>
<a name="3.cpp-28"></a>            <span class="n">k</span><span class="o">++</span><span class="p">;</span>
<a name="3.cpp-29"></a>        <span class="p">}</span>
<a name="3.cpp-30"></a>    <span class="p">}</span>
<a name="3.cpp-31"></a><span class="p">}</span>
<a name="3.cpp-32"></a>
<a name="3.cpp-33"></a><span class="kt">int</span> <span class="nf">main</span><span class="p">()</span> <span class="p">{</span>
<a name="3.cpp-34"></a>    <span class="kt">int</span> <span class="n">a</span><span class="p">;</span>
<a name="3.cpp-35"></a>    <span class="n">std</span><span class="o">::</span><span class="n">cin</span> <span class="o">&gt;&gt;</span> <span class="n">a</span><span class="p">;</span>
<a name="3.cpp-36"></a>    <span class="kt">int</span> <span class="n">n</span> <span class="o">=</span> <span class="mi">2</span> <span class="o">*</span> <span class="n">a</span> <span class="o">+</span> <span class="mi">1</span><span class="p">;</span>
<a name="3.cpp-37"></a>    <span class="kt">int</span> <span class="o">**</span><span class="n">array</span> <span class="o">=</span> <span class="k">new</span> <span class="kt">int</span> <span class="o">*</span><span class="p">[</span><span class="n">n</span><span class="p">];</span>
<a name="3.cpp-38"></a>    <span class="k">for</span> <span class="p">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">n</span><span class="p">;</span> <span class="n">i</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span>
<a name="3.cpp-39"></a>        <span class="n">array</span><span class="p">[</span><span class="n">i</span><span class="p">]</span> <span class="o">=</span> <span class="k">new</span> <span class="kt">int</span><span class="p">[</span><span class="n">n</span><span class="p">];</span>
<a name="3.cpp-40"></a>    <span class="p">}</span>
<a name="3.cpp-41"></a>
<a name="3.cpp-42"></a>    <span class="n">spiralPrint</span><span class="p">(</span><span class="n">n</span><span class="p">,</span> <span class="n">n</span><span class="p">,</span> <span class="n">array</span><span class="p">);</span>
<a name="3.cpp-43"></a>    <span class="n">std</span><span class="o">::</span><span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="n">std</span><span class="o">::</span><span class="n">endl</span><span class="p">;</span>
<a name="3.cpp-44"></a>    <span class="k">for</span> <span class="p">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">n</span><span class="p">;</span> <span class="n">i</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span>
<a name="3.cpp-45"></a>        <span class="k">for</span> <span class="p">(</span><span class="kt">int</span> <span class="n">j</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="n">j</span> <span class="o">&lt;</span> <span class="n">n</span><span class="p">;</span> <span class="n">j</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span>
<a name="3.cpp-46"></a>            <span class="n">std</span><span class="o">::</span><span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="n">array</span><span class="p">[</span><span class="n">i</span><span class="p">][</span><span class="n">j</span><span class="p">]</span> <span class="o">&lt;&lt;</span> <span class="s">&quot; &quot;</span><span class="p">;</span>
<a name="3.cpp-47"></a>        <span class="p">}</span>
<a name="3.cpp-48"></a>        <span class="n">std</span><span class="o">::</span><span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="n">std</span><span class="o">::</span><span class="n">endl</span><span class="p">;</span>
<a name="3.cpp-49"></a>    <span class="p">}</span>
<a name="3.cpp-50"></a>	<span class="k">for</span> <span class="p">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">n</span><span class="p">;</span> <span class="n">i</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span>
<a name="3.cpp-51"></a>        <span class="k">delete</span><span class="p">[]</span> <span class="n">array</span><span class="p">[</span><span class="n">i</span><span class="p">];</span>
<a name="3.cpp-52"></a>    <span class="p">}</span>
<a name="3.cpp-53"></a>    <span class="k">delete</span><span class="p">[]</span> <span class="n">array</span><span class="p">;</span>
<a name="3.cpp-54"></a>    <span class="k">return</span> <span class="mi">0</span><span class="p">;</span>
<a name="3.cpp-55"></a><span class="p">}</span>
</pre></div>
</td></tr></table>
    </div>
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
            ...
            [[#hasMultipleHeads]]
              [[#heads]]
                <li class="comprev filter-item">
                  <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/assignment 1/3.cpp?at=[[safeName]]"
                     title="[[name]]">
                    [[name]] ([[shortChangeset]])
                  </a>
                </li>
            ...
            [[^hasMultipleHeads]]
              <li class="comprev filter-item">
                <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/assignment 1/3.cpp?at=[[safeName]]" title="[[name]]">
                  [[name]]
                </a>
              </li>
            [[/hasMultipleHeads]]
