...
data-atlassian-id="557058:6abab86b-fd61-4467-882d-25c55a8d91e7" />
  ...
  / source  / Assignment2 upgraded / BinarySearchTree.h
 &mdash; Bitbucket
</title>
...
<meta name="apitoken" content="{&quot;token&quot;: &quot;kwgTGDaoOrKZVpPR_oLY-iTZRrwUsivj2MR3nKL3Y2Ukxx-JUwRlb_c1GjX9OCQItA11UyDP9OTgg-qDkdU4zDT8NGAGow==&quot;, &quot;connectionId&quot;: 619065, &quot;expiration&quot;: 1489895517.66359}">
...
<header id="source-path">
    ...
    <div class="secondary-actions">
      <div class="aui-buttons">
          ...
          <a href="/braza501/c-course-hws/src/286c32a03bb5/Assignment2%20upgraded/BinarySearchTree.h?at=master"
            class="aui-button pjax-trigger" aria-pressed="true">
            Source
          </a>
          <a href="/braza501/c-course-hws/diff/Assignment2%20upgraded/BinarySearchTree.h?diff2=286c32a03bb5&at=master"
            class="aui-button pjax-trigger"
            title="Diff to previous change">
            Diff
          </a>
          <a href="/braza501/c-course-hws/history-node/286c32a03bb5/Assignment2%20upgraded/BinarySearchTree.h?at=master"
            class="aui-button pjax-trigger">
            History
          </a>
  ...
  <div id="editor-container" class="maskable"
       ...
       data-branch="master"
       data-path="Assignment2 upgraded/BinarySearchTree.h"
       data-source-url="/api/internal/repositories/braza501/c-course-hws/src/286c32a03bb586675f981e6fc28c3f6b037a0d61/Assignment2%20upgraded/BinarySearchTree.h">
        ...
        <div class="primary">
          <div class="aui-buttons">
              ...
              <button id="file-history-trigger" class="aui-button aui-button-light changeset-info"
                      ...
                      data-path="Assignment2%20upgraded/BinarySearchTree.h"
  ...
  <span class="aui-icon-dropdown"></span>
          ...
          <a href="/braza501/c-course-hws/full-commit/286c32a03bb5/Assignment2%20upgraded/BinarySearchTree.h" id="full-commit-link"
        ...
        <div class="secondary">
          ...
          <div class="aui-buttons">
              ...
              <a href="/braza501/c-course-hws/annotate/286c32a03bb586675f981e6fc28c3f6b037a0d61/Assignment2%20upgraded/BinarySearchTree.h?at=master"
                 class="aui-button aui-button-light pjax-trigger">Blame</a>
              
            
            <a href="/braza501/c-course-hws/raw/286c32a03bb586675f981e6fc28c3f6b037a0d61/Assignment2%20upgraded/BinarySearchTree.h" class="aui-button aui-button-light">Raw</a>
          </div>
...
<a href="#BinarySearchTree.h-102">102</a></pre></div></td><td class="code"><div class="codehilite highlight"><pre><span></span><a name="BinarySearchTree.h-1"></a><span class="c1">//</span>
...
<a name="BinarySearchTree.h-4"></a>
<a name="BinarySearchTree.h-5"></a><span class="cp">#pragma once</span>
<a name="BinarySearchTree.h-6"></a>
<a name="BinarySearchTree.h-7"></a><span class="c1">// Binary Search Tree with UNIQUE keys</span>
<a name="BinarySearchTree.h-8"></a>
<a name="BinarySearchTree.h-9"></a>
<a name="BinarySearchTree.h-10"></a><span class="c1">// for testing only</span>
<a name="BinarySearchTree.h-11"></a><span class="c1">// Returns total number of created Nodes</span>
<a name="BinarySearchTree.h-12"></a><span class="c1">// Can be useful to find memory leaks</span>
<a name="BinarySearchTree.h-13"></a><span class="kt">int</span> <span class="nf">TotalNodes</span><span class="p">();</span>
<a name="BinarySearchTree.h-14"></a>
<a name="BinarySearchTree.h-15"></a><span class="n">class</span> <span class="n">CBinarySearchTree</span> <span class="p">{</span>
<a name="BinarySearchTree.h-16"></a>    <span class="k">struct</span> <span class="n">Node</span><span class="p">;</span>
<a name="BinarySearchTree.h-17"></a><span class="nl">public</span><span class="p">:</span>
<a name="BinarySearchTree.h-18"></a>
<a name="BinarySearchTree.h-19"></a>
<a name="BinarySearchTree.h-20"></a>    <span class="c1">// default constructor</span>
<a name="BinarySearchTree.h-21"></a>    <span class="n">CBinarySearchTree</span><span class="p">()</span> <span class="p">{</span>
<a name="BinarySearchTree.h-22"></a>        <span class="n">root</span> <span class="o">=</span> <span class="n">nullptr</span><span class="p">;</span>
<a name="BinarySearchTree.h-23"></a>    <span class="p">}</span>
<a name="BinarySearchTree.h-24"></a>
<a name="BinarySearchTree.h-25"></a>    <span class="o">~</span><span class="n">CBinarySearchTree</span><span class="p">()</span> <span class="p">{</span>
<a name="BinarySearchTree.h-26"></a>        <span class="n">DeleteAll</span><span class="p">();</span>
<a name="BinarySearchTree.h-27"></a>    <span class="p">}</span>
<a name="BinarySearchTree.h-28"></a>
<a name="BinarySearchTree.h-29"></a>    <span class="n">CBinarySearchTree</span><span class="p">(</span><span class="k">const</span> <span class="n">CBinarySearchTree</span> <span class="o">&amp;</span><span class="n">other</span><span class="p">)</span> <span class="p">{</span>
<a name="BinarySearchTree.h-30"></a>        <span class="n">root</span> <span class="o">=</span> <span class="n">DeepCopy</span><span class="p">(</span><span class="n">other</span><span class="p">.</span><span class="n">root</span><span class="p">);</span>
<a name="BinarySearchTree.h-31"></a>        <span class="n">count</span> <span class="o">=</span> <span class="n">other</span><span class="p">.</span><span class="n">count</span><span class="p">;</span>
<a name="BinarySearchTree.h-32"></a>    <span class="p">}</span>
<a name="BinarySearchTree.h-33"></a>
<a name="BinarySearchTree.h-34"></a>    <span class="n">CBinarySearchTree</span><span class="o">&amp;</span> <span class="n">operator</span><span class="o">=</span><span class="p">(</span><span class="k">const</span> <span class="n">CBinarySearchTree</span> <span class="o">&amp;</span><span class="n">other</span><span class="p">);</span>
<a name="BinarySearchTree.h-35"></a>
<a name="BinarySearchTree.h-36"></a>    <span class="kt">void</span> <span class="nf">Add</span><span class="p">(</span><span class="kt">int</span> <span class="n">newKey</span><span class="p">,</span> <span class="kt">int</span> <span class="n">newValue</span><span class="p">);</span>
<a name="BinarySearchTree.h-37"></a>
<a name="BinarySearchTree.h-38"></a>    <span class="c1">// Checks if key presented in array</span>
<a name="BinarySearchTree.h-39"></a>    <span class="kt">bool</span> <span class="nf">Has</span><span class="p">(</span><span class="kt">int</span> <span class="n">keyToCheck</span><span class="p">)</span> <span class="k">const</span><span class="p">;</span>
<a name="BinarySearchTree.h-40"></a>
<a name="BinarySearchTree.h-41"></a>    <span class="c1">// Deletes key from the tree</span>
<a name="BinarySearchTree.h-42"></a>    <span class="c1">// Returns true if deleted</span>
<a name="BinarySearchTree.h-43"></a>    <span class="c1">// Cost in your mark 2 times bigger!!</span>
<a name="BinarySearchTree.h-44"></a>    <span class="kt">bool</span> <span class="nf">Delete</span><span class="p">(</span><span class="kt">int</span> <span class="n">keyToDelete</span><span class="p">);</span>
<a name="BinarySearchTree.h-45"></a>
<a name="BinarySearchTree.h-46"></a>    <span class="c1">// Get value for key</span>
<a name="BinarySearchTree.h-47"></a>    <span class="c1">// if key is not in tree - assert</span>
<a name="BinarySearchTree.h-48"></a>    <span class="kt">int</span> <span class="o">&amp;</span><span class="n">operator</span><span class="p">[](</span><span class="kt">int</span> <span class="n">keyToFind</span><span class="p">);</span>
<a name="BinarySearchTree.h-49"></a>
<a name="BinarySearchTree.h-50"></a>    <span class="k">const</span> <span class="kt">int</span> <span class="o">&amp;</span><span class="n">operator</span><span class="p">[](</span><span class="kt">int</span> <span class="n">keyToFind</span><span class="p">)</span> <span class="k">const</span><span class="p">;</span>
<a name="BinarySearchTree.h-51"></a>
<a name="BinarySearchTree.h-52"></a>    <span class="c1">// Returns size of tree</span>
<a name="BinarySearchTree.h-53"></a>    <span class="kt">int</span> <span class="nf">Size</span><span class="p">()</span> <span class="k">const</span> <span class="p">{</span>
<a name="BinarySearchTree.h-54"></a>        <span class="k">return</span> <span class="n">count</span><span class="p">;</span>
<a name="BinarySearchTree.h-55"></a>    <span class="p">}</span>
<a name="BinarySearchTree.h-56"></a>
<a name="BinarySearchTree.h-57"></a>    <span class="c1">// Returns if tree is empty</span>
<a name="BinarySearchTree.h-58"></a>    <span class="kt">bool</span> <span class="nf">IsEmpty</span><span class="p">()</span> <span class="k">const</span> <span class="p">{</span> <span class="k">return</span> <span class="n">count</span> <span class="o">==</span> <span class="mi">0</span><span class="p">;</span> <span class="p">};</span>
<a name="BinarySearchTree.h-59"></a>
<a name="BinarySearchTree.h-60"></a>    <span class="c1">// Deletes all tree elements</span>
<a name="BinarySearchTree.h-61"></a>    <span class="kt">void</span> <span class="nf">DeleteAll</span><span class="p">();</span>
<a name="BinarySearchTree.h-62"></a>
<a name="BinarySearchTree.h-63"></a>    <span class="c1">// Returns max depth of tree</span>
<a name="BinarySearchTree.h-64"></a>    <span class="kt">int</span> <span class="nf">MaxDepth</span><span class="p">()</span> <span class="k">const</span><span class="p">;</span>
<a name="BinarySearchTree.h-65"></a>
<a name="BinarySearchTree.h-66"></a><span class="nl">private</span><span class="p">:</span>
<a name="BinarySearchTree.h-67"></a>    <span class="n">Node</span> <span class="o">*</span><span class="n">FindMin</span><span class="p">(</span><span class="n">Node</span> <span class="o">*</span><span class="n">x</span><span class="p">);</span>
<a name="BinarySearchTree.h-68"></a>
<a name="BinarySearchTree.h-69"></a>    <span class="kt">bool</span> <span class="nf">get</span><span class="p">(</span><span class="kt">int</span> <span class="n">key</span><span class="p">)</span> <span class="k">const</span><span class="p">;</span>
<a name="BinarySearchTree.h-70"></a>
<a name="BinarySearchTree.h-71"></a>    <span class="kt">void</span> <span class="nf">DeleteAll</span><span class="p">(</span><span class="n">Node</span> <span class="o">*</span><span class="n">x</span><span class="p">);</span>
<a name="BinarySearchTree.h-72"></a>
<a name="BinarySearchTree.h-73"></a>    <span class="n">Node</span> <span class="o">*</span><span class="nf">get</span><span class="p">(</span><span class="n">Node</span> <span class="o">*</span><span class="n">x</span><span class="p">,</span> <span class="kt">int</span><span class="p">)</span> <span class="k">const</span><span class="p">;</span>
<a name="BinarySearchTree.h-74"></a>
<a name="BinarySearchTree.h-75"></a>    <span class="n">Node</span> <span class="o">*</span><span class="nf">put</span><span class="p">(</span><span class="n">Node</span> <span class="o">*</span><span class="n">x</span><span class="p">,</span> <span class="kt">int</span> <span class="n">key</span><span class="p">,</span> <span class="kt">int</span> <span class="n">val</span><span class="p">);</span>
<a name="BinarySearchTree.h-76"></a>
<a name="BinarySearchTree.h-77"></a>    <span class="n">Node</span> <span class="o">*</span><span class="nf">Delete</span><span class="p">(</span><span class="n">Node</span> <span class="o">*</span><span class="n">x</span><span class="p">,</span> <span class="kt">int</span> <span class="n">key</span><span class="p">);</span>
<a name="BinarySearchTree.h-78"></a>
<a name="BinarySearchTree.h-79"></a>    <span class="kt">int</span> <span class="nf">MaxDepth</span><span class="p">(</span><span class="n">Node</span> <span class="o">*</span><span class="n">x</span><span class="p">)</span> <span class="k">const</span><span class="p">;</span>
<a name="BinarySearchTree.h-80"></a>
<a name="BinarySearchTree.h-81"></a>    <span class="n">Node</span><span class="o">*</span> <span class="nf">DeepCopy</span><span class="p">(</span><span class="k">const</span> <span class="n">Node</span> <span class="o">*</span><span class="n">x</span><span class="p">);</span>
<a name="BinarySearchTree.h-82"></a>
<a name="BinarySearchTree.h-83"></a>    <span class="k">struct</span> <span class="n">Node</span> <span class="p">{</span>
<a name="BinarySearchTree.h-84"></a>        <span class="n">Node</span> <span class="o">*</span><span class="n">left</span> <span class="o">=</span> <span class="n">nullptr</span><span class="p">;</span>
<a name="BinarySearchTree.h-85"></a>        <span class="n">Node</span> <span class="o">*</span><span class="n">right</span> <span class="o">=</span> <span class="n">nullptr</span><span class="p">;</span>
<a name="BinarySearchTree.h-86"></a>        <span class="kt">int</span> <span class="n">key</span><span class="p">;</span>
<a name="BinarySearchTree.h-87"></a>        <span class="kt">int</span> <span class="n">value</span><span class="p">;</span>
<a name="BinarySearchTree.h-88"></a>
<a name="BinarySearchTree.h-89"></a>        <span class="n">Node</span><span class="p">(</span><span class="kt">int</span> <span class="n">_key</span><span class="p">,</span> <span class="kt">int</span> <span class="n">_value</span><span class="p">)</span> <span class="o">:</span> <span class="n">key</span><span class="p">(</span><span class="n">_key</span><span class="p">),</span> <span class="n">value</span><span class="p">(</span><span class="n">_value</span><span class="p">)</span> <span class="p">{</span> <span class="n">nodes</span><span class="o">++</span><span class="p">;</span> <span class="p">}</span>
<a name="BinarySearchTree.h-90"></a>
<a name="BinarySearchTree.h-91"></a>        <span class="o">~</span><span class="n">Node</span><span class="p">()</span> <span class="p">{</span> <span class="n">nodes</span><span class="o">--</span><span class="p">;</span> <span class="p">};</span>
<a name="BinarySearchTree.h-92"></a>        <span class="k">static</span> <span class="kt">int</span> <span class="n">nodes</span><span class="p">;</span>
<a name="BinarySearchTree.h-93"></a>
<a name="BinarySearchTree.h-94"></a>        <span class="n">friend</span> <span class="kt">int</span> <span class="nf">TotalNodes</span><span class="p">()</span> <span class="p">{</span> <span class="k">return</span> <span class="n">nodes</span><span class="p">;</span> <span class="p">}</span>
<a name="BinarySearchTree.h-95"></a>    <span class="p">};</span>
<a name="BinarySearchTree.h-96"></a>
<a name="BinarySearchTree.h-97"></a>    <span class="kt">int</span> <span class="n">count</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
<a name="BinarySearchTree.h-98"></a>    <span class="n">Node</span> <span class="o">*</span><span class="n">root</span><span class="p">;</span>
<a name="BinarySearchTree.h-99"></a><span class="p">};</span>
<a name="BinarySearchTree.h-100"></a>
<a name="BinarySearchTree.h-101"></a><span class="kt">void</span> <span class="nf">TestBinarySearchTree</span><span class="p">();</span>
<a name="BinarySearchTree.h-102"></a>
</pre></div>
</td></tr></table>
    </div>
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
            ...
            [[#hasMultipleHeads]]
              [[#heads]]
                <li class="comprev filter-item">
                  <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/Assignment2 upgraded/BinarySearchTree.h?at=[[safeName]]"
                     title="[[name]]">
                    [[name]] ([[shortChangeset]])
                  </a>
                </li>
            ...
            [[^hasMultipleHeads]]
              <li class="comprev filter-item">
                <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/Assignment2 upgraded/BinarySearchTree.h?at=[[safeName]]" title="[[name]]">
                  [[name]]
                </a>
              </li>
            [[/hasMultipleHeads]]
