...
<meta name="apitoken" content="{&quot;token&quot;: &quot;JugjUo630MHIBb6DwJEC-KhIO1H_smq777_X24MNSeg6JopWNTqaXDqLLMMQ-HLGaljtL595OWpj1dtdA9O1i_gze6qa&quot;, &quot;connectionId&quot;: 619065, &quot;expiration&quot;: 1489896348.004047}">
...
<header id="source-path">
    ...
    <div class="secondary-actions">
      <div class="aui-buttons">
          ...
          <a href="/braza501/c-course-hws/src/286c32a03bb5/HW7/ArrayOfInts.h?at=master"
            class="aui-button pjax-trigger" aria-pressed="true">
            Source
          </a>
          <a href="/braza501/c-course-hws/diff/HW7/ArrayOfInts.h?diff2=286c32a03bb5&at=master"
            class="aui-button pjax-trigger"
            title="Diff to previous change">
            Diff
          </a>
          <a href="/braza501/c-course-hws/history-node/286c32a03bb5/HW7/ArrayOfInts.h?at=master"
            class="aui-button pjax-trigger">
            History
          </a>
  ...
  <div id="editor-container" class="maskable"
       ...
       data-branch="master"
       data-path="HW7/ArrayOfInts.h"
       data-source-url="/api/internal/repositories/braza501/c-course-hws/src/286c32a03bb586675f981e6fc28c3f6b037a0d61/HW7/ArrayOfInts.h">
  ...
  <span class="aui-icon-dropdown"></span>
          ...
          <a href="/braza501/c-course-hws/full-commit/286c32a03bb5/HW7/ArrayOfInts.h" id="full-commit-link"
        ...
        <div class="secondary">
          ...
          <div class="aui-buttons">
              ...
              <a href="/braza501/c-course-hws/annotate/286c32a03bb586675f981e6fc28c3f6b037a0d61/HW7/ArrayOfInts.h?at=master"
                 class="aui-button aui-button-light pjax-trigger">Blame</a>
              
            
            <a href="/braza501/c-course-hws/raw/286c32a03bb586675f981e6fc28c3f6b037a0d61/HW7/ArrayOfInts.h" class="aui-button aui-button-light">Raw</a>
          </div>
...
<a href="#ArrayOfInts.h-109">109</a></pre></div></td><td class="code"><div class="codehilite highlight"><pre><span></span><a name="ArrayOfInts.h-1"></a><span class="c1">//Author : Alexey Bandura</span>
<a name="ArrayOfInts.h-2"></a><span class="cp">#pragma once</span>
<a name="ArrayOfInts.h-3"></a>
<a name="ArrayOfInts.h-4"></a><span class="n">class</span> <span class="n">CArray</span> <span class="p">{</span>
<a name="ArrayOfInts.h-5"></a>
<a name="ArrayOfInts.h-6"></a><span class="nl">public</span><span class="p">:</span>
<a name="ArrayOfInts.h-7"></a>
<a name="ArrayOfInts.h-8"></a>    <span class="c1">// creates empty array with capacity 2</span>
<a name="ArrayOfInts.h-9"></a>    <span class="n">CArray</span><span class="p">();</span>
<a name="ArrayOfInts.h-10"></a>
<a name="ArrayOfInts.h-11"></a>    <span class="c1">//deallocates dynamic memory of the array</span>
<a name="ArrayOfInts.h-12"></a>    <span class="c1">// if it was not done in the FreeBuffer method.</span>
<a name="ArrayOfInts.h-13"></a>    <span class="o">~</span><span class="n">CArray</span><span class="p">();</span>
<a name="ArrayOfInts.h-14"></a>
<a name="ArrayOfInts.h-15"></a>    <span class="c1">// Elements count</span>
<a name="ArrayOfInts.h-16"></a>    <span class="kt">int</span> <span class="nf">Size</span><span class="p">()</span> <span class="k">const</span><span class="p">;</span>
<a name="ArrayOfInts.h-17"></a>
<a name="ArrayOfInts.h-18"></a>    <span class="c1">// Capacity</span>
<a name="ArrayOfInts.h-19"></a>    <span class="kt">int</span> <span class="nf">BufferSize</span><span class="p">()</span> <span class="k">const</span><span class="p">;</span>
<a name="ArrayOfInts.h-20"></a>
<a name="ArrayOfInts.h-21"></a>    <span class="c1">// Doesn&#39;t array contain any elements?</span>
<a name="ArrayOfInts.h-22"></a>    <span class="kt">bool</span> <span class="nf">IsEmpty</span><span class="p">()</span> <span class="k">const</span><span class="p">;</span>
<a name="ArrayOfInts.h-23"></a>
<a name="ArrayOfInts.h-24"></a>    <span class="c1">// Get pointer</span>
<a name="ArrayOfInts.h-25"></a>    <span class="kt">int</span> <span class="o">*</span><span class="nf">GetPtr</span><span class="p">();</span>
<a name="ArrayOfInts.h-26"></a>
<a name="ArrayOfInts.h-27"></a>    <span class="k">const</span> <span class="kt">int</span> <span class="o">*</span><span class="nf">GetPtr</span><span class="p">()</span> <span class="k">const</span><span class="p">;</span>
<a name="ArrayOfInts.h-28"></a>
<a name="ArrayOfInts.h-29"></a>    <span class="c1">// Subscription</span>
<a name="ArrayOfInts.h-30"></a>    <span class="kt">int</span> <span class="o">&amp;</span><span class="n">operator</span><span class="p">[](</span><span class="kt">int</span> <span class="n">index</span><span class="p">);</span>
<a name="ArrayOfInts.h-31"></a>
<a name="ArrayOfInts.h-32"></a>    <span class="k">const</span> <span class="kt">int</span> <span class="o">&amp;</span><span class="n">operator</span><span class="p">[](</span><span class="kt">int</span> <span class="n">index</span><span class="p">)</span> <span class="k">const</span><span class="p">;</span>
<a name="ArrayOfInts.h-33"></a>
<a name="ArrayOfInts.h-34"></a>    <span class="c1">// Last element</span>
<a name="ArrayOfInts.h-35"></a>    <span class="k">const</span> <span class="kt">int</span> <span class="o">&amp;</span><span class="n">Last</span><span class="p">()</span> <span class="k">const</span><span class="p">;</span>
<a name="ArrayOfInts.h-36"></a>
<a name="ArrayOfInts.h-37"></a>    <span class="kt">int</span> <span class="o">&amp;</span><span class="n">Last</span><span class="p">();</span>
<a name="ArrayOfInts.h-38"></a>
<a name="ArrayOfInts.h-39"></a>    <span class="c1">// First element</span>
<a name="ArrayOfInts.h-40"></a>    <span class="k">const</span> <span class="kt">int</span> <span class="o">&amp;</span><span class="n">First</span><span class="p">()</span> <span class="k">const</span><span class="p">;</span>
<a name="ArrayOfInts.h-41"></a>
<a name="ArrayOfInts.h-42"></a>    <span class="kt">int</span> <span class="o">&amp;</span><span class="n">First</span><span class="p">();</span>
<a name="ArrayOfInts.h-43"></a>
<a name="ArrayOfInts.h-44"></a>    <span class="c1">// Chech if index is within array bounds</span>
<a name="ArrayOfInts.h-45"></a>    <span class="kt">bool</span> <span class="nf">IsValidIndex</span><span class="p">(</span><span class="kt">int</span> <span class="n">index</span><span class="p">)</span> <span class="k">const</span><span class="p">;</span>
<a name="ArrayOfInts.h-46"></a>
<a name="ArrayOfInts.h-47"></a>    <span class="c1">// Set buffer size, cant shrink</span>
<a name="ArrayOfInts.h-48"></a>    <span class="kt">void</span> <span class="nf">SetBufferSize</span><span class="p">(</span><span class="kt">int</span> <span class="n">nElements</span><span class="p">);</span>
<a name="ArrayOfInts.h-49"></a>
<a name="ArrayOfInts.h-50"></a>    <span class="c1">// The same as SetBufferSize.</span>
<a name="ArrayOfInts.h-51"></a>    <span class="kt">void</span> <span class="nf">Grow</span><span class="p">(</span><span class="kt">int</span> <span class="n">newSize</span><span class="p">);</span>
<a name="ArrayOfInts.h-52"></a>
<a name="ArrayOfInts.h-53"></a>    <span class="c1">// Replace element at index.</span>
<a name="ArrayOfInts.h-54"></a>    <span class="kt">void</span> <span class="nf">ReplaceAt</span><span class="p">(</span><span class="k">const</span> <span class="kt">int</span> <span class="o">&amp;</span><span class="n">newElem</span><span class="p">,</span> <span class="kt">int</span> <span class="n">location</span><span class="p">);</span>
<a name="ArrayOfInts.h-55"></a>
<a name="ArrayOfInts.h-56"></a>    <span class="c1">// Sets arrays size</span>
<a name="ArrayOfInts.h-57"></a>    <span class="c1">// If new size is greater adds new elements to the end (uninitialized integers)</span>
<a name="ArrayOfInts.h-58"></a>    <span class="kt">void</span> <span class="nf">SetSize</span><span class="p">(</span><span class="kt">int</span> <span class="n">newSize</span><span class="p">);</span>
<a name="ArrayOfInts.h-59"></a>
<a name="ArrayOfInts.h-60"></a>    <span class="c1">// Add elements to the end.</span>
<a name="ArrayOfInts.h-61"></a>    <span class="kt">void</span> <span class="nf">Add</span><span class="p">(</span><span class="k">const</span> <span class="kt">int</span> <span class="o">&amp;</span><span class="n">anElem</span><span class="p">);</span>
<a name="ArrayOfInts.h-62"></a>
<a name="ArrayOfInts.h-63"></a>    <span class="kt">void</span> <span class="nf">Add</span><span class="p">(</span><span class="k">const</span> <span class="kt">int</span> <span class="o">&amp;</span><span class="n">anElem</span><span class="p">,</span> <span class="kt">int</span> <span class="n">count</span><span class="p">);</span>
<a name="ArrayOfInts.h-64"></a>
<a name="ArrayOfInts.h-65"></a>    <span class="kt">void</span> <span class="nf">Add</span><span class="p">(</span><span class="k">const</span> <span class="n">CArray</span> <span class="o">&amp;</span><span class="n">ar</span><span class="p">);</span>
<a name="ArrayOfInts.h-66"></a>
<a name="ArrayOfInts.h-67"></a>    <span class="c1">// Insert element to position.</span>
<a name="ArrayOfInts.h-68"></a>    <span class="kt">void</span> <span class="nf">InsertAt</span><span class="p">(</span><span class="k">const</span> <span class="kt">int</span> <span class="o">&amp;</span><span class="n">what</span><span class="p">,</span> <span class="kt">int</span> <span class="n">location</span><span class="p">);</span>
<a name="ArrayOfInts.h-69"></a>
<a name="ArrayOfInts.h-70"></a>    <span class="kt">void</span> <span class="nf">InsertAt</span><span class="p">(</span><span class="k">const</span> <span class="kt">int</span> <span class="o">&amp;</span><span class="n">what</span><span class="p">,</span> <span class="kt">int</span> <span class="n">location</span><span class="p">,</span> <span class="kt">int</span> <span class="n">count</span><span class="p">);</span>
<a name="ArrayOfInts.h-71"></a>
<a name="ArrayOfInts.h-72"></a>    <span class="kt">void</span> <span class="nf">InsertAt</span><span class="p">(</span><span class="k">const</span> <span class="n">CArray</span> <span class="o">&amp;</span><span class="n">what</span><span class="p">,</span> <span class="kt">int</span> <span class="n">location</span><span class="p">);</span>
<a name="ArrayOfInts.h-73"></a>
<a name="ArrayOfInts.h-74"></a>    <span class="c1">// Delete element at index</span>
<a name="ArrayOfInts.h-75"></a>    <span class="c1">// Does not shrinks the buffer</span>
<a name="ArrayOfInts.h-76"></a>    <span class="kt">void</span> <span class="nf">DeleteAt</span><span class="p">(</span><span class="kt">int</span> <span class="n">location</span><span class="p">,</span> <span class="kt">int</span> <span class="n">num</span> <span class="o">=</span> <span class="mi">1</span><span class="p">);</span>
<a name="ArrayOfInts.h-77"></a>
<a name="ArrayOfInts.h-78"></a>    <span class="c1">// Deleting last element. Presence in checked with presume</span>
<a name="ArrayOfInts.h-79"></a>    <span class="kt">void</span> <span class="nf">DeleteLast</span><span class="p">();</span>
<a name="ArrayOfInts.h-80"></a>
<a name="ArrayOfInts.h-81"></a>    <span class="c1">// Delete all element, for deleting elements destructor are called</span>
<a name="ArrayOfInts.h-82"></a>    <span class="c1">// Does not shrinks the buffer</span>
<a name="ArrayOfInts.h-83"></a>    <span class="kt">void</span> <span class="nf">DeleteAll</span><span class="p">();</span>
<a name="ArrayOfInts.h-84"></a>
<a name="ArrayOfInts.h-85"></a>    <span class="c1">// Delete all elements and free buffer</span>
<a name="ArrayOfInts.h-86"></a>    <span class="c1">// Warning: buffer is nullptr after performing the operation</span>
<a name="ArrayOfInts.h-87"></a>    <span class="kt">void</span> <span class="nf">FreeBuffer</span><span class="p">();</span>
<a name="ArrayOfInts.h-88"></a>
<a name="ArrayOfInts.h-89"></a>    <span class="c1">// Copies all elements to dest, dest is cleared</span>
<a name="ArrayOfInts.h-90"></a>    <span class="kt">void</span> <span class="nf">CopyTo</span><span class="p">(</span><span class="n">CArray</span> <span class="o">&amp;</span><span class="n">dest</span><span class="p">)</span> <span class="k">const</span><span class="p">;</span>
<a name="ArrayOfInts.h-91"></a>
<a name="ArrayOfInts.h-92"></a>    <span class="c1">// Moves all elements to another array;</span>
<a name="ArrayOfInts.h-93"></a>    <span class="c1">// array to be moved is left with empty array of 2 capacity</span>
<a name="ArrayOfInts.h-94"></a>    <span class="c1">// before moveing dest is cleared.</span>
<a name="ArrayOfInts.h-95"></a>    <span class="kt">void</span> <span class="nf">MoveTo</span><span class="p">(</span><span class="n">CArray</span> <span class="o">&amp;</span><span class="n">dest</span><span class="p">);</span>
<a name="ArrayOfInts.h-96"></a>
<a name="ArrayOfInts.h-97"></a>    <span class="c1">// Linear search.</span>
<a name="ArrayOfInts.h-98"></a>    <span class="kt">int</span> <span class="nf">Find</span><span class="p">(</span><span class="k">const</span> <span class="kt">int</span> <span class="o">&amp;</span><span class="n">what</span><span class="p">,</span> <span class="kt">int</span> <span class="n">startPos</span> <span class="o">=</span> <span class="mi">0</span><span class="p">)</span> <span class="k">const</span><span class="p">;</span>
<a name="ArrayOfInts.h-99"></a>
<a name="ArrayOfInts.h-100"></a>    <span class="c1">// Checks if element present in array</span>
<a name="ArrayOfInts.h-101"></a>    <span class="kt">bool</span> <span class="nf">Has</span><span class="p">(</span><span class="k">const</span> <span class="kt">int</span> <span class="o">&amp;</span><span class="n">what</span><span class="p">)</span> <span class="k">const</span><span class="p">;</span>
<a name="ArrayOfInts.h-102"></a>
<a name="ArrayOfInts.h-103"></a><span class="nl">private</span><span class="p">:</span>
<a name="ArrayOfInts.h-104"></a>    <span class="kt">int</span> <span class="o">*</span><span class="n">buffer</span><span class="p">;</span>
<a name="ArrayOfInts.h-105"></a>    <span class="kt">int</span> <span class="n">maxCapacity</span><span class="p">;</span>
<a name="ArrayOfInts.h-106"></a>    <span class="kt">int</span> <span class="n">size</span><span class="p">;</span>
<a name="ArrayOfInts.h-107"></a><span class="p">};</span>
<a name="ArrayOfInts.h-108"></a>
<a name="ArrayOfInts.h-109"></a><span class="kt">void</span> <span class="nf">TestCArray</span><span class="p">();</span>
</pre></div>
</td></tr></table>
    </div>
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
            ...
            [[#hasMultipleHeads]]
              [[#heads]]
                <li class="comprev filter-item">
                  <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/HW7/ArrayOfInts.h?at=[[safeName]]"
                     title="[[name]]">
                    [[name]] ([[shortChangeset]])
                  </a>
                </li>
            ...
            [[^hasMultipleHeads]]
              <li class="comprev filter-item">
                <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/HW7/ArrayOfInts.h?at=[[safeName]]" title="[[name]]">
                  [[name]]
                </a>
              </li>
            [[/hasMultipleHeads]]
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","queueTime":0,"licenseKey":"a2cef8c3d3","agent":"","transactionName":"Z11RZxdWW0cEVkYLDV4XdUYLVEFdClsdAAtEWkZQDlJBGgRFQhFMQl1DXFcZQ10AQkFYBFlUVlEXWEJHAA==","applicationID":"1841284","errorBeacon":"bam.nr-data.net","applicationTime":161}</script>
</body>
</html>