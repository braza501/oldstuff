...
<meta name="apitoken" content="{&quot;token&quot;: &quot;cyBS9llbPTrOLhcZ0za3pk6doeX6d-EbUjolwS38ZsYa7mfYT6b27EaY5ECjQqO6MMY68F8P3TPMcPYnOtahKZ53p1exWA==&quot;, &quot;connectionId&quot;: 619065, &quot;expiration&quot;: 1489895798.347519}">
...
<header id="source-path">
    ...
    <div class="secondary-actions">
      <div class="aui-buttons">
          ...
          <a href="/braza501/c-course-hws/src/286c32a03bb5/5.HomeTask/Main.cpp?at=master"
            class="aui-button pjax-trigger" aria-pressed="true">
            Source
          </a>
          <a href="/braza501/c-course-hws/diff/5.HomeTask/Main.cpp?diff2=286c32a03bb5&at=master"
            class="aui-button pjax-trigger"
            title="Diff to previous change">
            Diff
          </a>
          <a href="/braza501/c-course-hws/history-node/286c32a03bb5/5.HomeTask/Main.cpp?at=master"
            class="aui-button pjax-trigger">
            History
          </a>
  ...
  <div id="editor-container" class="maskable"
       ...
       data-branch="master"
       data-path="5.HomeTask/Main.cpp"
       data-source-url="/api/internal/repositories/braza501/c-course-hws/src/286c32a03bb586675f981e6fc28c3f6b037a0d61/5.HomeTask/Main.cpp">
  ...
  <span class="aui-icon-dropdown"></span>
          ...
          <a href="/braza501/c-course-hws/full-commit/286c32a03bb5/5.HomeTask/Main.cpp" id="full-commit-link"
        ...
        <div class="secondary">
          ...
          <div class="aui-buttons">
              ...
              <a href="/braza501/c-course-hws/annotate/286c32a03bb586675f981e6fc28c3f6b037a0d61/5.HomeTask/Main.cpp?at=master"
                 class="aui-button aui-button-light pjax-trigger">Blame</a>
              
            
            <a href="/braza501/c-course-hws/raw/286c32a03bb586675f981e6fc28c3f6b037a0d61/5.HomeTask/Main.cpp" class="aui-button aui-button-light">Raw</a>
          </div>
    ...
    <div class="file-source">
      <table class="codehilite highlighttable"><tr><td class="linenos"><div class="linenodiv"><pre><a href="#Main.cpp-1"> 1</a>
<a href="#Main.cpp-2"> 2</a>
<a href="#Main.cpp-3"> 3</a>
<a href="#Main.cpp-4"> 4</a>
<a href="#Main.cpp-5"> 5</a>
<a href="#Main.cpp-6"> 6</a>
<a href="#Main.cpp-7"> 7</a>
<a href="#Main.cpp-8"> 8</a>
<a href="#Main.cpp-9"> 9</a>
<a href="#Main.cpp-10">10</a>
<a href="#Main.cpp-11">11</a>
<a href="#Main.cpp-12">12</a>
<a href="#Main.cpp-13">13</a>
<a href="#Main.cpp-14">14</a>
<a href="#Main.cpp-15">15</a>
<a href="#Main.cpp-16">16</a>
<a href="#Main.cpp-17">17</a>
<a href="#Main.cpp-18">18</a>
<a href="#Main.cpp-19">19</a>
<a href="#Main.cpp-20">20</a>
<a href="#Main.cpp-21">21</a>
<a href="#Main.cpp-22">22</a>
<a href="#Main.cpp-23">23</a>
<a href="#Main.cpp-24">24</a>
<a href="#Main.cpp-25">25</a>
<a href="#Main.cpp-26">26</a>
<a href="#Main.cpp-27">27</a>
<a href="#Main.cpp-28">28</a>
<a href="#Main.cpp-29">29</a>
<a href="#Main.cpp-30">30</a>
<a href="#Main.cpp-31">31</a>
<a href="#Main.cpp-32">32</a>
<a href="#Main.cpp-33">33</a>
<a href="#Main.cpp-34">34</a>
<a href="#Main.cpp-35">35</a>
<a href="#Main.cpp-36">36</a>
<a href="#Main.cpp-37">37</a>
<a href="#Main.cpp-38">38</a></pre></div></td><td class="code"><div class="codehilite highlight"><pre><span></span><a name="Main.cpp-1"></a>
<a name="Main.cpp-2"></a><span class="cp">#include</span> <span class="cpf">&lt;iostream&gt;</span><span class="cp"></span>
<a name="Main.cpp-3"></a><span class="cp">#include</span> <span class="cpf">&lt;algorithm&gt;</span><span class="cp"></span>
<a name="Main.cpp-4"></a><span class="cp">#include</span> <span class="cpf">&lt;string&gt;</span><span class="cp"></span>
<a name="Main.cpp-5"></a><span class="cp">#include</span> <span class="cpf">&lt;ctime&gt;</span><span class="cp"></span>
<a name="Main.cpp-6"></a><span class="cp">#include</span> <span class="cpf">&lt;cstdlib&gt;</span><span class="cp"></span>
<a name="Main.cpp-7"></a><span class="cp">#include</span> <span class="cpf">&lt;sstream&gt;</span><span class="cp"></span>
<a name="Main.cpp-8"></a><span class="cp">#include</span> <span class="cpf">&lt;cmath&gt;</span><span class="cp"></span>
<a name="Main.cpp-9"></a>
<a name="Main.cpp-10"></a><span class="cp">#include</span> <span class="cpf">&quot;MathOperations.h&quot;</span><span class="cp"></span>
<a name="Main.cpp-11"></a><span class="cp">#include</span> <span class="cpf">&quot;ArrayOperations.h&quot;</span><span class="cp"></span>
<a name="Main.cpp-12"></a>
<a name="Main.cpp-13"></a>
<a name="Main.cpp-14"></a><span class="kt">int</span> <span class="nf">main</span><span class="p">()</span> <span class="p">{</span>
<a name="Main.cpp-15"></a>
<a name="Main.cpp-16"></a>    <span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">TestSqrt</span><span class="p">())</span> <span class="p">{</span>
<a name="Main.cpp-17"></a>        <span class="n">std</span><span class="o">::</span><span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="s">&quot;Wrong Sqrt function &quot;</span> <span class="o">&lt;&lt;</span> <span class="n">std</span><span class="o">::</span><span class="n">endl</span><span class="p">;</span>
<a name="Main.cpp-18"></a>    <span class="p">}</span>
<a name="Main.cpp-19"></a>    <span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">TestInsertionSort</span><span class="p">())</span> <span class="p">{</span>
<a name="Main.cpp-20"></a>        <span class="n">std</span><span class="o">::</span><span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="s">&quot;Wrong Insertion Sort &quot;</span> <span class="o">&lt;&lt;</span> <span class="n">std</span><span class="o">::</span><span class="n">endl</span><span class="p">;</span>
<a name="Main.cpp-21"></a>    <span class="p">}</span>
<a name="Main.cpp-22"></a>    <span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">TestBubbleSort</span><span class="p">())</span> <span class="p">{</span>
<a name="Main.cpp-23"></a>        <span class="n">std</span><span class="o">::</span><span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="s">&quot;Wrong Bubble Sort &quot;</span> <span class="o">&lt;&lt;</span> <span class="n">std</span><span class="o">::</span><span class="n">endl</span><span class="p">;</span>
<a name="Main.cpp-24"></a>    <span class="p">}</span>
<a name="Main.cpp-25"></a>    <span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">TestSelectionSort</span><span class="p">())</span> <span class="p">{</span>
<a name="Main.cpp-26"></a>        <span class="n">std</span><span class="o">::</span><span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="s">&quot;Wrong Selection Sort &quot;</span> <span class="o">&lt;&lt;</span> <span class="n">std</span><span class="o">::</span><span class="n">endl</span><span class="p">;</span>
<a name="Main.cpp-27"></a>    <span class="p">}</span>
<a name="Main.cpp-28"></a>    <span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">TestMerge</span><span class="p">())</span> <span class="p">{</span>
<a name="Main.cpp-29"></a>        <span class="n">std</span><span class="o">::</span><span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="s">&quot;Wrong Merge Function &quot;</span> <span class="o">&lt;&lt;</span> <span class="n">std</span><span class="o">::</span><span class="n">endl</span><span class="p">;</span>
<a name="Main.cpp-30"></a>    <span class="p">}</span>
<a name="Main.cpp-31"></a>    <span class="n">Test2dArraysWithSort</span><span class="p">(</span><span class="mi">5</span><span class="p">,</span> <span class="mi">5</span><span class="p">);</span>
<a name="Main.cpp-32"></a>    <span class="n">Test3dArrays</span><span class="p">(</span><span class="mi">4</span><span class="p">,</span> <span class="mi">3</span><span class="p">,</span> <span class="mi">5</span><span class="p">);</span>
<a name="Main.cpp-33"></a>    <span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">TestMergeSort</span><span class="p">())</span> <span class="p">{</span>
<a name="Main.cpp-34"></a>        <span class="n">std</span><span class="o">::</span><span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="s">&quot;Wrong MergeSort&quot;</span> <span class="o">&lt;&lt;</span> <span class="n">std</span><span class="o">::</span><span class="n">endl</span><span class="p">;</span>
<a name="Main.cpp-35"></a>    <span class="p">}</span>
<a name="Main.cpp-36"></a>    <span class="k">return</span> <span class="mi">0</span><span class="p">;</span>
<a name="Main.cpp-37"></a><span class="p">}</span>
<a name="Main.cpp-38"></a>
</pre></div>
</td></tr></table>
    </div>
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
            ...
            [[#hasMultipleHeads]]
              [[#heads]]
                <li class="comprev filter-item">
                  <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/5.HomeTask/Main.cpp?at=[[safeName]]"
                     title="[[name]]">
                    [[name]] ([[shortChangeset]])
                  </a>
                </li>
            ...
            [[^hasMultipleHeads]]
              <li class="comprev filter-item">
                <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/5.HomeTask/Main.cpp?at=[[safeName]]" title="[[name]]">
                  [[name]]
                </a>
              </li>
            [[/hasMultipleHeads]]
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","queueTime":0,"licenseKey":"a2cef8c3d3","agent":"","transactionName":"Z11RZxdWW0cEVkYLDV4XdUYLVEFdClsdAAtEWkZQDlJBGgRFQhFMQl1DXFcZQ10AQkFYBFlUVlEXWEJHAA==","applicationID":"1841284","errorBeacon":"bam.nr-data.net","applicationTime":179}</script>
</body>
</html>