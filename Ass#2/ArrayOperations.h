...
data-atlassian-id="557058:6abab86b-fd61-4467-882d-25c55a8d91e7" />
  ...
  / source  / 5.HomeTask / ArrayOperations.h
 &mdash; Bitbucket
</title>
...
<meta name="apitoken" content="{&quot;token&quot;: &quot;OXy6DeYSJpqRdr4-5Rxmg-lCos6vpcc9wivwmzGXptlsfNAiYYwOsF6NuboVlzBeVdRXJBwj1DXbaf9UjuyiGKlkqX5d4A==&quot;, &quot;connectionId&quot;: 619065, &quot;expiration&quot;: 1489895770.183761}">
...
<header id="source-path">
    ...
    <div class="secondary-actions">
      <div class="aui-buttons">
          ...
          <a href="/braza501/c-course-hws/src/286c32a03bb5/5.HomeTask/ArrayOperations.h?at=master"
            class="aui-button pjax-trigger" aria-pressed="true">
            Source
          </a>
          <a href="/braza501/c-course-hws/diff/5.HomeTask/ArrayOperations.h?diff2=286c32a03bb5&at=master"
            class="aui-button pjax-trigger"
            title="Diff to previous change">
            Diff
          </a>
          <a href="/braza501/c-course-hws/history-node/286c32a03bb5/5.HomeTask/ArrayOperations.h?at=master"
            class="aui-button pjax-trigger">
            History
          </a>
  ...
  <h1>
        ...
        <a href="/braza501/c-course-hws/src/286c32a03bb5?at=master"
          class="pjax-trigger root" title="braza501/c-course-hws at 286c32a03bb5">C++ Course HWs</a> /
            ...
            <span class="file-name">ArrayOperations.h</span>
  ...
  <div id="editor-container" class="maskable"
       ...
       data-branch="master"
       data-path="5.HomeTask/ArrayOperations.h"
       data-source-url="/api/internal/repositories/braza501/c-course-hws/src/286c32a03bb586675f981e6fc28c3f6b037a0d61/5.HomeTask/ArrayOperations.h">
  ...
  <span class="aui-icon-dropdown"></span>
          ...
          <a href="/braza501/c-course-hws/full-commit/286c32a03bb5/5.HomeTask/ArrayOperations.h" id="full-commit-link"
        ...
        <div class="secondary">
          ...
          <div class="aui-buttons">
              ...
              <a href="/braza501/c-course-hws/annotate/286c32a03bb586675f981e6fc28c3f6b037a0d61/5.HomeTask/ArrayOperations.h?at=master"
                 class="aui-button aui-button-light pjax-trigger">Blame</a>
              
            
            <a href="/braza501/c-course-hws/raw/286c32a03bb586675f981e6fc28c3f6b037a0d61/5.HomeTask/ArrayOperations.h" class="aui-button aui-button-light">Raw</a>
          </div>
    ...
    <div class="file-source">
      <table class="codehilite highlighttable"><tr><td class="linenos"><div class="linenodiv"><pre><a href="#ArrayOperations.h-1"> 1</a>
<a href="#ArrayOperations.h-2"> 2</a>
<a href="#ArrayOperations.h-3"> 3</a>
<a href="#ArrayOperations.h-4"> 4</a>
<a href="#ArrayOperations.h-5"> 5</a>
<a href="#ArrayOperations.h-6"> 6</a>
<a href="#ArrayOperations.h-7"> 7</a>
<a href="#ArrayOperations.h-8"> 8</a>
<a href="#ArrayOperations.h-9"> 9</a>
<a href="#ArrayOperations.h-10">10</a>
<a href="#ArrayOperations.h-11">11</a>
<a href="#ArrayOperations.h-12">12</a>
<a href="#ArrayOperations.h-13">13</a>
<a href="#ArrayOperations.h-14">14</a>
<a href="#ArrayOperations.h-15">15</a>
<a href="#ArrayOperations.h-16">16</a>
<a href="#ArrayOperations.h-17">17</a>
<a href="#ArrayOperations.h-18">18</a>
<a href="#ArrayOperations.h-19">19</a>
<a href="#ArrayOperations.h-20">20</a>
<a href="#ArrayOperations.h-21">21</a>
<a href="#ArrayOperations.h-22">22</a>
<a href="#ArrayOperations.h-23">23</a>
<a href="#ArrayOperations.h-24">24</a>
<a href="#ArrayOperations.h-25">25</a>
<a href="#ArrayOperations.h-26">26</a>
<a href="#ArrayOperations.h-27">27</a>
<a href="#ArrayOperations.h-28">28</a>
<a href="#ArrayOperations.h-29">29</a>
<a href="#ArrayOperations.h-30">30</a>
<a href="#ArrayOperations.h-31">31</a>
<a href="#ArrayOperations.h-32">32</a>
<a href="#ArrayOperations.h-33">33</a>
<a href="#ArrayOperations.h-34">34</a>
<a href="#ArrayOperations.h-35">35</a>
<a href="#ArrayOperations.h-36">36</a>
<a href="#ArrayOperations.h-37">37</a>
<a href="#ArrayOperations.h-38">38</a>
<a href="#ArrayOperations.h-39">39</a>
<a href="#ArrayOperations.h-40">40</a>
<a href="#ArrayOperations.h-41">41</a>
<a href="#ArrayOperations.h-42">42</a>
<a href="#ArrayOperations.h-43">43</a>
<a href="#ArrayOperations.h-44">44</a>
<a href="#ArrayOperations.h-45">45</a></pre></div></td><td class="code"><div class="codehilite highlight"><pre><span></span><a name="ArrayOperations.h-1"></a><span class="c1">//Author: Alexey Bandura</span>
<a name="ArrayOperations.h-2"></a><span class="c1">//Description:</span>
<a name="ArrayOperations.h-3"></a>
<a name="ArrayOperations.h-4"></a><span class="cp">#pragma once</span>
<a name="ArrayOperations.h-5"></a>
<a name="ArrayOperations.h-6"></a><span class="cp">#include</span> <span class="cpf">&lt;string&gt;</span><span class="cp"></span>
<a name="ArrayOperations.h-7"></a>
<a name="ArrayOperations.h-8"></a><span class="c1">//Description: creates and filles out the array with</span>
<a name="ArrayOperations.h-9"></a><span class="c1">//random numbers</span>
<a name="ArrayOperations.h-10"></a><span class="kt">int</span><span class="o">*</span> <span class="nf">CreateRandomArray</span><span class="p">(</span> <span class="kt">int</span> <span class="n">arraySize</span> <span class="p">);</span>
<a name="ArrayOperations.h-11"></a>
<a name="ArrayOperations.h-12"></a><span class="c1">//Description: prints out an array</span>
<a name="ArrayOperations.h-13"></a><span class="kt">void</span> <span class="nf">PrintArray</span><span class="p">(</span><span class="kt">int</span> <span class="o">*</span><span class="n">array</span><span class="p">,</span> <span class="kt">int</span> <span class="n">size</span><span class="p">);</span>
<a name="ArrayOperations.h-14"></a><span class="c1">// Description: checks whether array is sorted</span>
<a name="ArrayOperations.h-15"></a><span class="kt">bool</span> <span class="nf">IsSorted</span><span class="p">(</span><span class="kt">int</span> <span class="o">*</span><span class="n">array</span><span class="p">,</span> <span class="kt">int</span> <span class="n">size</span><span class="p">);</span>
<a name="ArrayOperations.h-16"></a><span class="c1">// Description: sorts an array using insertion sort</span>
<a name="ArrayOperations.h-17"></a><span class="kt">void</span> <span class="nf">InsertionSort</span><span class="p">(</span><span class="kt">int</span> <span class="o">*</span><span class="n">array</span><span class="p">,</span> <span class="kt">int</span> <span class="n">size</span><span class="p">);</span>
<a name="ArrayOperations.h-18"></a><span class="c1">// Description: sorts an array using Bubble sort</span>
<a name="ArrayOperations.h-19"></a><span class="kt">void</span> <span class="nf">BubbleSort</span><span class="p">(</span><span class="kt">int</span> <span class="o">*</span><span class="n">array</span><span class="p">,</span> <span class="kt">int</span> <span class="n">size</span><span class="p">);</span>
<a name="ArrayOperations.h-20"></a><span class="c1">// Description: sorts an array using Selection sort</span>
<a name="ArrayOperations.h-21"></a><span class="kt">void</span> <span class="nf">SelectionSort</span><span class="p">(</span><span class="kt">int</span> <span class="o">*</span><span class="n">array</span><span class="p">,</span> <span class="kt">int</span> <span class="n">size</span><span class="p">);</span>
<a name="ArrayOperations.h-22"></a><span class="c1">// Description: tests correctness of the insertion sort</span>
<a name="ArrayOperations.h-23"></a><span class="kt">bool</span> <span class="nf">TestInsertionSort</span><span class="p">();</span>
<a name="ArrayOperations.h-24"></a><span class="c1">// Description: tests correctness of the bubble sort</span>
<a name="ArrayOperations.h-25"></a><span class="kt">bool</span> <span class="nf">TestBubbleSort</span><span class="p">();</span>
<a name="ArrayOperations.h-26"></a><span class="c1">// Description: tests correctness of the selection sort</span>
<a name="ArrayOperations.h-27"></a><span class="kt">bool</span> <span class="nf">TestSelectionSort</span><span class="p">();</span>
<a name="ArrayOperations.h-28"></a><span class="c1">// Description: finds an element  using linear search, -1 if not presented</span>
<a name="ArrayOperations.h-29"></a><span class="kt">int</span> <span class="nf">LinearSearch</span><span class="p">(</span><span class="kt">int</span> <span class="o">*</span><span class="n">array</span><span class="p">,</span> <span class="kt">int</span> <span class="n">size</span><span class="p">,</span> <span class="kt">int</span> <span class="n">element</span><span class="p">);</span>
<a name="ArrayOperations.h-30"></a><span class="c1">// Description: finds an element  using lbinary search, -1 if not presented</span>
<a name="ArrayOperations.h-31"></a><span class="c1">// or array is not sorted</span>
<a name="ArrayOperations.h-32"></a><span class="kt">int</span> <span class="nf">BinarySearch</span><span class="p">(</span><span class="kt">int</span> <span class="o">*</span><span class="n">array</span><span class="p">,</span> <span class="kt">int</span> <span class="n">size</span><span class="p">,</span> <span class="kt">int</span> <span class="n">elementToFind</span><span class="p">);</span>
<a name="ArrayOperations.h-33"></a><span class="c1">// Description: takes two sorted arrays and produces single one sorted array</span>
<a name="ArrayOperations.h-34"></a><span class="kt">int</span> <span class="o">*</span><span class="nf">Merge</span><span class="p">(</span><span class="kt">int</span> <span class="o">*</span><span class="n">a</span><span class="p">,</span> <span class="kt">int</span> <span class="n">size_a</span><span class="p">,</span> <span class="kt">int</span> <span class="o">*</span><span class="n">b</span><span class="p">,</span> <span class="kt">int</span> <span class="n">size_b</span><span class="p">);</span>
<a name="ArrayOperations.h-35"></a><span class="c1">// Description: checks if new merged array is sorted</span>
<a name="ArrayOperations.h-36"></a><span class="kt">bool</span> <span class="nf">TestMerge</span><span class="p">();</span>
<a name="ArrayOperations.h-37"></a><span class="c1">// Description: creates 3 dimensional array and fill it with random numbers.</span>
<a name="ArrayOperations.h-38"></a><span class="kt">void</span> <span class="nf">Test3dArrays</span><span class="p">(</span><span class="kt">int</span> <span class="n">N</span><span class="p">,</span> <span class="kt">int</span> <span class="n">M</span><span class="p">,</span> <span class="kt">int</span> <span class="n">R</span><span class="p">);</span>
<a name="ArrayOperations.h-39"></a><span class="c1">// Description: Sorts even lines of a matrix in ascending order and odd lines in descending.</span>
<a name="ArrayOperations.h-40"></a><span class="c1">// Prints array. Deletes array.</span>
<a name="ArrayOperations.h-41"></a><span class="kt">void</span> <span class="nf">Test2dArraysWithSort</span><span class="p">(</span><span class="kt">int</span> <span class="n">n</span><span class="p">,</span> <span class="kt">int</span> <span class="n">m</span><span class="p">);</span>
<a name="ArrayOperations.h-42"></a><span class="c1">// Description: sorts an array using merge sort.</span>
<a name="ArrayOperations.h-43"></a><span class="kt">void</span> <span class="nf">MergeSort</span><span class="p">(</span><span class="kt">int</span> <span class="o">*</span><span class="n">array</span><span class="p">,</span> <span class="kt">int</span> <span class="n">size</span><span class="p">);</span>
<a name="ArrayOperations.h-44"></a><span class="c1">// Description: tests correctness of the merge sort</span>
<a name="ArrayOperations.h-45"></a><span class="kt">bool</span> <span class="nf">TestMergeSort</span><span class="p">();</span>
</pre></div>
</td></tr></table>
    </div>
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
            ...
            [[#hasMultipleHeads]]
              [[#heads]]
                <li class="comprev filter-item">
                  <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/5.HomeTask/ArrayOperations.h?at=[[safeName]]"
                     title="[[name]]">
                    [[name]] ([[shortChangeset]])
                  </a>
                </li>
            ...
            [[^hasMultipleHeads]]
              <li class="comprev filter-item">
                <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/5.HomeTask/ArrayOperations.h?at=[[safeName]]" title="[[name]]">
                  [[name]]
                </a>
              </li>
            [[/hasMultipleHeads]]
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","queueTime":0,"licenseKey":"a2cef8c3d3","agent":"","transactionName":"Z11RZxdWW0cEVkYLDV4XdUYLVEFdClsdAAtEWkZQDlJBGgRFQhFMQl1DXFcZQ10AQkFYBFlUVlEXWEJHAA==","applicationID":"1841284","errorBeacon":"bam.nr-data.net","applicationTime":326}</script>
</body>
</html>