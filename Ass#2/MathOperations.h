...
data-atlassian-id="557058:6abab86b-fd61-4467-882d-25c55a8d91e7" />
  ...
  / source  / 5.HomeTask / MathOperations.h
 &mdash; Bitbucket
</title>
...
<meta name="apitoken" content="{&quot;token&quot;: &quot;HFBWUSK70LbsGWoBIL8EcjdUoPaJ9EzeuRvvb26UVnj6sBarCo6g6CVSt-baQUUNo0Ok82bTbWznFG3Ff4h1F2ReKNhw3Q==&quot;, &quot;connectionId&quot;: 619065, &quot;expiration&quot;: 1489895927.084262}">
...
<header id="source-path">
    ...
    <div class="secondary-actions">
      <div class="aui-buttons">
          ...
          <a href="/braza501/c-course-hws/src/286c32a03bb5/5.HomeTask/MathOperations.h?at=master"
            class="aui-button pjax-trigger" aria-pressed="true">
            Source
          </a>
          <a href="/braza501/c-course-hws/diff/5.HomeTask/MathOperations.h?diff2=286c32a03bb5&at=master"
            class="aui-button pjax-trigger"
            title="Diff to previous change">
            Diff
          </a>
          <a href="/braza501/c-course-hws/history-node/286c32a03bb5/5.HomeTask/MathOperations.h?at=master"
            class="aui-button pjax-trigger">
            History
          </a>
  ...
  <h1>
        ...
        <a href="/braza501/c-course-hws/src/286c32a03bb5?at=master"
          class="pjax-trigger root" title="braza501/c-course-hws at 286c32a03bb5">C++ Course HWs</a> /
            ...
            <span class="file-name">MathOperations.h</span>
  ...
  <div id="editor-container" class="maskable"
       ...
       data-branch="master"
       data-path="5.HomeTask/MathOperations.h"
       data-source-url="/api/internal/repositories/braza501/c-course-hws/src/286c32a03bb586675f981e6fc28c3f6b037a0d61/5.HomeTask/MathOperations.h">
  ...
  <span class="aui-icon-dropdown"></span>
          ...
          <a href="/braza501/c-course-hws/full-commit/286c32a03bb5/5.HomeTask/MathOperations.h" id="full-commit-link"
        ...
        <div class="secondary">
          ...
          <div class="aui-buttons">
              ...
              <a href="/braza501/c-course-hws/annotate/286c32a03bb586675f981e6fc28c3f6b037a0d61/5.HomeTask/MathOperations.h?at=master"
                 class="aui-button aui-button-light pjax-trigger">Blame</a>
              
            
            <a href="/braza501/c-course-hws/raw/286c32a03bb586675f981e6fc28c3f6b037a0d61/5.HomeTask/MathOperations.h" class="aui-button aui-button-light">Raw</a>
          </div>
    ...
    <div class="file-source">
      <table class="codehilite highlighttable"><tr><td class="linenos"><div class="linenodiv"><pre><a href="#MathOperations.h-1"> 1</a>
<a href="#MathOperations.h-2"> 2</a>
<a href="#MathOperations.h-3"> 3</a>
<a href="#MathOperations.h-4"> 4</a>
<a href="#MathOperations.h-5"> 5</a>
<a href="#MathOperations.h-6"> 6</a>
<a href="#MathOperations.h-7"> 7</a>
<a href="#MathOperations.h-8"> 8</a>
<a href="#MathOperations.h-9"> 9</a>
<a href="#MathOperations.h-10">10</a>
<a href="#MathOperations.h-11">11</a></pre></div></td><td class="code"><div class="codehilite highlight"><pre><span></span><a name="MathOperations.h-1"></a>
<a name="MathOperations.h-2"></a><span class="c1">//Author: Alexey Bandura</span>
<a name="MathOperations.h-3"></a><span class="c1">//Description:</span>
<a name="MathOperations.h-4"></a><span class="cp">#pragma once</span>
<a name="MathOperations.h-5"></a>
<a name="MathOperations.h-6"></a><span class="c1">// Description: finds square root of a number r with a specified precision</span>
<a name="MathOperations.h-7"></a><span class="c1">// using binary search. In other words, performs bisection method where</span>
<a name="MathOperations.h-8"></a><span class="c1">// our function is x^2 - r &lt;= accuracy</span>
<a name="MathOperations.h-9"></a><span class="kt">double</span> <span class="nf">Sqrt</span><span class="p">(</span> <span class="kt">double</span> <span class="n">r</span><span class="p">,</span> <span class="kt">double</span> <span class="n">accuracy</span> <span class="p">);</span>
<a name="MathOperations.h-10"></a><span class="c1">// Description: checks correctness of the previous function</span>
<a name="MathOperations.h-11"></a><span class="kt">bool</span> <span class="nf">TestSqrt</span><span class="p">();</span>
</pre></div>
</td></tr></table>
    </div>
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
            ...
            [[#hasMultipleHeads]]
              [[#heads]]
                <li class="comprev filter-item">
                  <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/5.HomeTask/MathOperations.h?at=[[safeName]]"
                     title="[[name]]">
                    [[name]] ([[shortChangeset]])
                  </a>
                </li>
            ...
            [[^hasMultipleHeads]]
              <li class="comprev filter-item">
                <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/5.HomeTask/MathOperations.h?at=[[safeName]]" title="[[name]]">
                  [[name]]
                </a>
              </li>
            [[/hasMultipleHeads]]
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","queueTime":0,"licenseKey":"a2cef8c3d3","agent":"","transactionName":"Z11RZxdWW0cEVkYLDV4XdUYLVEFdClsdAAtEWkZQDlJBGgRFQhFMQl1DXFcZQ10AQkFYBFlUVlEXWEJHAA==","applicationID":"1841284","errorBeacon":"bam.nr-data.net","applicationTime":407}</script>
</body>
</html>