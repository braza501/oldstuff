...
data-atlassian-id="557058:6abab86b-fd61-4467-882d-25c55a8d91e7" />
  ...
  / source  / 5.HomeTask / MathOperations.cpp
 &mdash; Bitbucket
</title>
...
<meta name="apitoken" content="{&quot;token&quot;: &quot;zBJk0vEG6J7qGK837OonUs4nHfLyCCVb76pjwVPagiX_pF9PUIvT7P4Nl4wDRNY6_UrSXYtpHwfoGdx73nLz_IFdH0k5Zg==&quot;, &quot;connectionId&quot;: 619065, &quot;expiration&quot;: 1489895923.440085}">
...
<header id="source-path">
    ...
    <div class="secondary-actions">
      <div class="aui-buttons">
          ...
          <a href="/braza501/c-course-hws/src/286c32a03bb5/5.HomeTask/MathOperations.cpp?at=master"
            class="aui-button pjax-trigger" aria-pressed="true">
            Source
          </a>
          <a href="/braza501/c-course-hws/diff/5.HomeTask/MathOperations.cpp?diff2=286c32a03bb5&at=master"
            class="aui-button pjax-trigger"
            title="Diff to previous change">
            Diff
          </a>
          <a href="/braza501/c-course-hws/history-node/286c32a03bb5/5.HomeTask/MathOperations.cpp?at=master"
            class="aui-button pjax-trigger">
            History
          </a>
  ...
  <h1>
        ...
        <a href="/braza501/c-course-hws/src/286c32a03bb5?at=master"
          class="pjax-trigger root" title="braza501/c-course-hws at 286c32a03bb5">C++ Course HWs</a> /
            ...
            <span class="file-name">MathOperations.cpp</span>
  ...
  <div id="editor-container" class="maskable"
       ...
       data-branch="master"
       data-path="5.HomeTask/MathOperations.cpp"
       data-source-url="/api/internal/repositories/braza501/c-course-hws/src/286c32a03bb586675f981e6fc28c3f6b037a0d61/5.HomeTask/MathOperations.cpp">
  ...
  <span class="aui-icon-dropdown"></span>
          ...
          <a href="/braza501/c-course-hws/full-commit/286c32a03bb5/5.HomeTask/MathOperations.cpp" id="full-commit-link"
        ...
        <div class="secondary">
          ...
          <div class="aui-buttons">
              ...
              <a href="/braza501/c-course-hws/annotate/286c32a03bb586675f981e6fc28c3f6b037a0d61/5.HomeTask/MathOperations.cpp?at=master"
                 class="aui-button aui-button-light pjax-trigger">Blame</a>
              
            
            <a href="/braza501/c-course-hws/raw/286c32a03bb586675f981e6fc28c3f6b037a0d61/5.HomeTask/MathOperations.cpp" class="aui-button aui-button-light">Raw</a>
          </div>
    ...
    <div class="file-source">
      <table class="codehilite highlighttable"><tr><td class="linenos"><div class="linenodiv"><pre><a href="#MathOperations.cpp-1"> 1</a>
<a href="#MathOperations.cpp-2"> 2</a>
<a href="#MathOperations.cpp-3"> 3</a>
<a href="#MathOperations.cpp-4"> 4</a>
<a href="#MathOperations.cpp-5"> 5</a>
<a href="#MathOperations.cpp-6"> 6</a>
<a href="#MathOperations.cpp-7"> 7</a>
<a href="#MathOperations.cpp-8"> 8</a>
<a href="#MathOperations.cpp-9"> 9</a>
<a href="#MathOperations.cpp-10">10</a>
<a href="#MathOperations.cpp-11">11</a>
<a href="#MathOperations.cpp-12">12</a>
<a href="#MathOperations.cpp-13">13</a>
<a href="#MathOperations.cpp-14">14</a>
<a href="#MathOperations.cpp-15">15</a>
<a href="#MathOperations.cpp-16">16</a>
<a href="#MathOperations.cpp-17">17</a>
<a href="#MathOperations.cpp-18">18</a>
<a href="#MathOperations.cpp-19">19</a>
<a href="#MathOperations.cpp-20">20</a>
<a href="#MathOperations.cpp-21">21</a>
<a href="#MathOperations.cpp-22">22</a>
<a href="#MathOperations.cpp-23">23</a>
<a href="#MathOperations.cpp-24">24</a>
<a href="#MathOperations.cpp-25">25</a>
<a href="#MathOperations.cpp-26">26</a>
<a href="#MathOperations.cpp-27">27</a>
<a href="#MathOperations.cpp-28">28</a>
<a href="#MathOperations.cpp-29">29</a>
<a href="#MathOperations.cpp-30">30</a>
<a href="#MathOperations.cpp-31">31</a>
<a href="#MathOperations.cpp-32">32</a>
<a href="#MathOperations.cpp-33">33</a>
<a href="#MathOperations.cpp-34">34</a>
<a href="#MathOperations.cpp-35">35</a>
<a href="#MathOperations.cpp-36">36</a>
<a href="#MathOperations.cpp-37">37</a>
<a href="#MathOperations.cpp-38">38</a>
<a href="#MathOperations.cpp-39">39</a>
<a href="#MathOperations.cpp-40">40</a>
<a href="#MathOperations.cpp-41">41</a>
<a href="#MathOperations.cpp-42">42</a>
<a href="#MathOperations.cpp-43">43</a>
<a href="#MathOperations.cpp-44">44</a>
<a href="#MathOperations.cpp-45">45</a>
<a href="#MathOperations.cpp-46">46</a></pre></div></td><td class="code"><div class="codehilite highlight"><pre><span></span><a name="MathOperations.cpp-1"></a><span class="cp">#include</span> <span class="cpf">&lt;iostream&gt;</span><span class="cp"></span>
<a name="MathOperations.cpp-2"></a><span class="cp">#include</span> <span class="cpf">&lt;string&gt;</span><span class="cp"></span>
<a name="MathOperations.cpp-3"></a><span class="cp">#include</span> <span class="cpf">&lt;ctime&gt;</span><span class="cp"></span>
<a name="MathOperations.cpp-4"></a><span class="cp">#include</span> <span class="cpf">&lt;cstdlib&gt;</span><span class="cp"></span>
<a name="MathOperations.cpp-5"></a><span class="cp">#include</span> <span class="cpf">&lt;sstream&gt;</span><span class="cp"></span>
<a name="MathOperations.cpp-6"></a><span class="cp">#include</span> <span class="cpf">&lt;cmath&gt;</span><span class="cp"></span>
<a name="MathOperations.cpp-7"></a>
<a name="MathOperations.cpp-8"></a><span class="cp">#include</span> <span class="cpf">&quot;MathOperations.h&quot;</span><span class="cp"></span>
<a name="MathOperations.cpp-9"></a>
<a name="MathOperations.cpp-10"></a><span class="kt">double</span> <span class="nf">fRand</span><span class="p">(</span><span class="kt">double</span> <span class="n">fMin</span><span class="p">,</span> <span class="kt">double</span> <span class="n">fMax</span><span class="p">)</span> <span class="p">{</span>
<a name="MathOperations.cpp-11"></a>    <span class="kt">double</span> <span class="n">f</span> <span class="o">=</span> <span class="p">(</span><span class="kt">double</span><span class="p">)</span> <span class="n">rand</span><span class="p">()</span> <span class="o">/</span> <span class="n">RAND_MAX</span><span class="p">;</span>
<a name="MathOperations.cpp-12"></a>    <span class="k">return</span> <span class="n">fMin</span> <span class="o">+</span> <span class="n">f</span> <span class="o">*</span> <span class="p">(</span><span class="n">fMax</span> <span class="o">-</span> <span class="n">fMin</span><span class="p">);</span>
<a name="MathOperations.cpp-13"></a><span class="p">}</span>
<a name="MathOperations.cpp-14"></a>
<a name="MathOperations.cpp-15"></a><span class="kt">double</span> <span class="nf">Sqrt</span><span class="p">(</span><span class="kt">double</span> <span class="n">r</span><span class="p">,</span> <span class="kt">double</span> <span class="n">epsilon</span><span class="p">)</span> <span class="p">{</span>
<a name="MathOperations.cpp-16"></a>    <span class="k">if</span> <span class="p">(</span><span class="n">r</span> <span class="o">==</span> <span class="mi">0</span> <span class="o">||</span> <span class="n">r</span> <span class="o">==</span> <span class="mi">1</span><span class="p">)</span> <span class="p">{</span>
<a name="MathOperations.cpp-17"></a>        <span class="k">return</span> <span class="n">r</span><span class="p">;</span>
<a name="MathOperations.cpp-18"></a>    <span class="p">}</span>
<a name="MathOperations.cpp-19"></a>    <span class="kt">double</span> <span class="n">low</span> <span class="o">=</span> <span class="mi">1</span><span class="p">,</span> <span class="n">high</span> <span class="o">=</span> <span class="n">r</span><span class="p">;</span>
<a name="MathOperations.cpp-20"></a>    <span class="kt">double</span> <span class="n">mid</span> <span class="o">=</span> <span class="p">(</span><span class="n">low</span> <span class="o">+</span> <span class="n">high</span><span class="p">)</span> <span class="o">/</span> <span class="mf">2.0</span><span class="p">;</span>
<a name="MathOperations.cpp-21"></a>    <span class="k">while</span> <span class="p">(</span><span class="n">std</span><span class="o">::</span><span class="n">fabs</span><span class="p">(</span><span class="n">mid</span> <span class="o">*</span> <span class="n">mid</span> <span class="o">-</span> <span class="n">r</span><span class="p">)</span> <span class="o">&gt;</span> <span class="n">epsilon</span><span class="p">)</span> <span class="p">{</span>
<a name="MathOperations.cpp-22"></a>        <span class="n">mid</span> <span class="o">=</span> <span class="p">(</span><span class="n">low</span> <span class="o">+</span> <span class="n">high</span><span class="p">)</span> <span class="o">/</span> <span class="mf">2.0</span><span class="p">;</span>
<a name="MathOperations.cpp-23"></a>        <span class="k">if</span> <span class="p">(</span><span class="n">mid</span> <span class="o">*</span> <span class="n">mid</span> <span class="o">&lt;</span> <span class="n">r</span><span class="p">)</span> <span class="p">{</span>
<a name="MathOperations.cpp-24"></a>            <span class="n">low</span> <span class="o">=</span> <span class="n">mid</span> <span class="o">+</span> <span class="mi">1</span><span class="p">;</span>
<a name="MathOperations.cpp-25"></a>        <span class="p">}</span> <span class="k">else</span> <span class="p">{</span>
<a name="MathOperations.cpp-26"></a>            <span class="n">high</span> <span class="o">=</span> <span class="n">mid</span> <span class="o">-</span> <span class="mi">1</span><span class="p">;</span>
<a name="MathOperations.cpp-27"></a>        <span class="p">}</span>
<a name="MathOperations.cpp-28"></a>    <span class="p">}</span>
<a name="MathOperations.cpp-29"></a>    <span class="k">return</span> <span class="n">mid</span><span class="p">;</span>
<a name="MathOperations.cpp-30"></a><span class="p">}</span>
<a name="MathOperations.cpp-31"></a>
<a name="MathOperations.cpp-32"></a><span class="kt">bool</span> <span class="nf">TestSqrt</span><span class="p">()</span> <span class="p">{</span>
<a name="MathOperations.cpp-33"></a>    <span class="n">std</span><span class="o">::</span><span class="n">srand</span><span class="p">(</span><span class="n">time</span><span class="p">(</span><span class="nb">NULL</span><span class="p">));</span>
<a name="MathOperations.cpp-34"></a>    <span class="k">for</span> <span class="p">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="mi">3</span><span class="p">;</span> <span class="n">i</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span>
<a name="MathOperations.cpp-35"></a>        <span class="kt">double</span> <span class="n">number</span> <span class="o">=</span> <span class="n">fRand</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="mi">500</span><span class="p">);</span>
<a name="MathOperations.cpp-36"></a>        <span class="kt">double</span> <span class="n">precision</span> <span class="o">=</span> <span class="n">fRand</span><span class="p">(</span> <span class="mf">0.00001</span><span class="p">,</span> <span class="mf">0.01</span><span class="p">);</span>
<a name="MathOperations.cpp-37"></a>        <span class="kt">double</span> <span class="n">result</span> <span class="o">=</span> <span class="n">Sqrt</span><span class="p">(</span><span class="n">number</span><span class="p">,</span> <span class="n">precision</span><span class="p">);</span>
<a name="MathOperations.cpp-38"></a>        <span class="k">if</span> <span class="p">(</span><span class="n">std</span><span class="o">::</span><span class="n">fabs</span><span class="p">(</span><span class="n">result</span> <span class="o">*</span> <span class="n">result</span> <span class="o">-</span> <span class="n">number</span><span class="p">)</span> <span class="o">&gt;</span> <span class="n">precision</span><span class="p">)</span> <span class="p">{</span>
<a name="MathOperations.cpp-39"></a>            <span class="k">return</span> <span class="nb">false</span><span class="p">;</span>
<a name="MathOperations.cpp-40"></a>        <span class="p">}</span>
<a name="MathOperations.cpp-41"></a>    <span class="p">}</span>
<a name="MathOperations.cpp-42"></a>    <span class="k">return</span> <span class="nb">true</span><span class="p">;</span>
<a name="MathOperations.cpp-43"></a><span class="p">}</span>
<a name="MathOperations.cpp-44"></a>
<a name="MathOperations.cpp-45"></a>
<a name="MathOperations.cpp-46"></a>
</pre></div>
</td></tr></table>
    </div>
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
            ...
            [[#hasMultipleHeads]]
              [[#heads]]
                <li class="comprev filter-item">
                  <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/5.HomeTask/MathOperations.cpp?at=[[safeName]]"
                     title="[[name]]">
                    [[name]] ([[shortChangeset]])
                  </a>
                </li>
            ...
            [[^hasMultipleHeads]]
              <li class="comprev filter-item">
                <a class="pjax-trigger filter-item-link" href="/braza501/c-course-hws/src/[[changeset]]/5.HomeTask/MathOperations.cpp?at=[[safeName]]" title="[[name]]">
                  [[name]]
                </a>
              </li>
            [[/hasMultipleHeads]]
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","queueTime":0,"licenseKey":"a2cef8c3d3","agent":"","transactionName":"Z11RZxdWW0cEVkYLDV4XdUYLVEFdClsdAAtEWkZQDlJBGgRFQhFMQl1DXFcZQ10AQkFYBFlUVlEXWEJHAA==","applicationID":"1841284","errorBeacon":"bam.nr-data.net","applicationTime":162}</script>
</body>
</html>